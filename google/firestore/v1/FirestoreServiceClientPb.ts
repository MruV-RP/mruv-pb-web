/**
 * @fileoverview gRPC-Web generated client stub for google.firestore.v1
 * @enhanceable
 * @public
 */
...
export class FirestoreClient {
  ...
  methodInfoGetDocument = new grpcWeb.AbstractClientBase.MethodInfo(
    google_firestore_v1_document_pb.Document,
    (request: GetDocumentRequest) => {
      return request.serializeBinary();
    },
    google_firestore_v1_document_pb.Document.deserializeBinary
  );
  ...
  getDocument(
    ...
    callback: (err: grpcWeb.Error,
               response: google_firestore_v1_document_pb.Document) => void) {
