...
export class Write extends jspb.Message {
  ...
  setUpdate(value?: google_firestore_v1beta1_document_pb.Document): void;
  hasUpdate(): boolean;
  clearUpdate(): void;
...
export namespace DocumentTransform {
  ...
  export class FieldTransform extends jspb.Message {
    ...
    getIncrement(): google_firestore_v1beta1_document_pb.Value | undefined;
    setIncrement(value?: google_firestore_v1beta1_document_pb.Value): void;
    hasIncrement(): boolean;
    clearIncrement(): void;

    getMaximum(): google_firestore_v1beta1_document_pb.Value | undefined;
    setMaximum(value?: google_firestore_v1beta1_document_pb.Value): void;
    hasMaximum(): boolean;
    clearMaximum(): void;

    getMinimum(): google_firestore_v1beta1_document_pb.Value | undefined;
    setMinimum(value?: google_firestore_v1beta1_document_pb.Value): void;
    hasMinimum(): boolean;
    clearMinimum(): void;

    getAppendMissingElements(): google_firestore_v1beta1_document_pb.ArrayValue | undefined;
    setAppendMissingElements(value?: google_firestore_v1beta1_document_pb.ArrayValue): void;
    ...
    setRemoveAllFromArray(value?: google_firestore_v1beta1_document_pb.ArrayValue): void;
  ...
  export namespace FieldTransform {
    export type AsObject = {
      ...
      increment?: google_firestore_v1beta1_document_pb.Value.AsObject,
      maximum?: google_firestore_v1beta1_document_pb.Value.AsObject,
      minimum?: google_firestore_v1beta1_document_pb.Value.AsObject,
...
export class WriteResult extends jspb.Message {
  ...
  setTransformResultsList(value: Array<google_firestore_v1beta1_document_pb.Value>): void;
