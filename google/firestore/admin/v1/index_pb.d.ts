...
export class Index extends jspb.Message {
  ...
  setQueryScope(value: Index.QueryScope): void;
  ...
  setState(value: Index.State): void;
...
export namespace Index {
  ...
  export class IndexField extends jspb.Message {
    ...
    setOrder(value: Index.IndexField.Order): void;

    getArrayConfig(): Index.IndexField.ArrayConfig;
    setArrayConfig(value: Index.IndexField.ArrayConfig): void;
