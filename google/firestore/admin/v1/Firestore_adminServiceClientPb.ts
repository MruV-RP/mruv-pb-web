/**
 * @fileoverview gRPC-Web generated client stub for google.firestore.admin.v1
 * @enhanceable
 * @public
 */
...
export class FirestoreAdminClient {
  ...
  methodInfoGetIndex = new grpcWeb.AbstractClientBase.MethodInfo(
    google_firestore_admin_v1_index_pb.Index,
    (request: GetIndexRequest) => {
      return request.serializeBinary();
    },
    google_firestore_admin_v1_index_pb.Index.deserializeBinary
  );
  ...
  getIndex(
    ...
    metadata: grpcWeb.Metadata | null,
    callback: (err: grpcWeb.Error,
               response: google_firestore_admin_v1_index_pb.Index) => void) {
    return this.client_.rpcCall(
      this.hostname_ +
  ...
  methodInfoGetField = new grpcWeb.AbstractClientBase.MethodInfo(
    google_firestore_admin_v1_field_pb.Field,
    (request: GetFieldRequest) => {
      return request.serializeBinary();
    },
    google_firestore_admin_v1_field_pb.Field.deserializeBinary
  );
  ...
  getField(
    ...
    metadata: grpcWeb.Metadata | null,
    callback: (err: grpcWeb.Error,
               response: google_firestore_admin_v1_field_pb.Field) => void) {
    return this.client_.rpcCall(
      this.hostname_ +
