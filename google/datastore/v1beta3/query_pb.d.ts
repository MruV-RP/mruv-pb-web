...
export class EntityResult extends jspb.Message {
  getEntity(): google_datastore_v1beta3_entity_pb.Entity | undefined;
  setEntity(value?: google_datastore_v1beta3_entity_pb.Entity): void;
  hasEntity(): boolean;
  clearEntity(): void;
...
export namespace EntityResult {
  export type AsObject = {
    entity?: google_datastore_v1beta3_entity_pb.Entity.AsObject,
    version: number,
...
export class PropertyFilter extends jspb.Message {
  ...
  getValue(): google_datastore_v1beta3_entity_pb.Value | undefined;
  setValue(value?: google_datastore_v1beta3_entity_pb.Value): void;
  hasValue(): boolean;
  clearValue(): void;
...
export namespace PropertyFilter {
  export type AsObject = {
    ...
    value?: google_datastore_v1beta3_entity_pb.Value.AsObject,
  }
