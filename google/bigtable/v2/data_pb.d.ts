...
export class RowRange extends jspb.Message {
  getStartKeyClosed(): Uint8Array | string;
  getStartKeyClosed_asU8(): Uint8Array;
  getStartKeyClosed_asB64(): string;
  setStartKeyClosed(value: Uint8Array | string): void;

  getStartKeyOpen(): Uint8Array | string;
  getStartKeyOpen_asU8(): Uint8Array;
  getStartKeyOpen_asB64(): string;
  setStartKeyOpen(value: Uint8Array | string): void;

  getEndKeyOpen(): Uint8Array | string;
  getEndKeyOpen_asU8(): Uint8Array;
  getEndKeyOpen_asB64(): string;
  setEndKeyOpen(value: Uint8Array | string): void;

  getEndKeyClosed(): Uint8Array | string;
  getEndKeyClosed_asU8(): Uint8Array;
  getEndKeyClosed_asB64(): string;
  setEndKeyClosed(value: Uint8Array | string): void;

  getStartKeyCase(): RowRange.StartKeyCase;

  getEndKeyCase(): RowRange.EndKeyCase;
...
export namespace RowRange {
  export type AsObject = {
    startKeyClosed: Uint8Array | string,
    startKeyOpen: Uint8Array | string,
    endKeyOpen: Uint8Array | string,
    endKeyClosed: Uint8Array | string,
  }

  export enum StartKeyCase { 
    START_KEY_NOT_SET = 0,
    START_KEY_CLOSED = 1,
    START_KEY_OPEN = 2,
  }

  export enum EndKeyCase { 
    END_KEY_NOT_SET = 0,
    END_KEY_OPEN = 3,
    END_KEY_CLOSED = 4,
  }
...
export class ColumnRange extends jspb.Message {
  ...
  getStartQualifierClosed(): Uint8Array | string;
  getStartQualifierClosed_asU8(): Uint8Array;
  getStartQualifierClosed_asB64(): string;
  setStartQualifierClosed(value: Uint8Array | string): void;

  getStartQualifierOpen(): Uint8Array | string;
  getStartQualifierOpen_asU8(): Uint8Array;
  getStartQualifierOpen_asB64(): string;
  setStartQualifierOpen(value: Uint8Array | string): void;

  getEndQualifierClosed(): Uint8Array | string;
  getEndQualifierClosed_asU8(): Uint8Array;
  getEndQualifierClosed_asB64(): string;
  setEndQualifierClosed(value: Uint8Array | string): void;

  getEndQualifierOpen(): Uint8Array | string;
  getEndQualifierOpen_asU8(): Uint8Array;
  getEndQualifierOpen_asB64(): string;
  setEndQualifierOpen(value: Uint8Array | string): void;
...
export namespace ColumnRange {
  export type AsObject = {
    familyName: string,
    startQualifierClosed: Uint8Array | string,
    startQualifierOpen: Uint8Array | string,
    endQualifierClosed: Uint8Array | string,
    endQualifierOpen: Uint8Array | string,
  }
...
export class ValueRange extends jspb.Message {
  getStartValueClosed(): Uint8Array | string;
  getStartValueClosed_asU8(): Uint8Array;
  getStartValueClosed_asB64(): string;
  setStartValueClosed(value: Uint8Array | string): void;

  getStartValueOpen(): Uint8Array | string;
  getStartValueOpen_asU8(): Uint8Array;
  getStartValueOpen_asB64(): string;
  setStartValueOpen(value: Uint8Array | string): void;

  getEndValueClosed(): Uint8Array | string;
  getEndValueClosed_asU8(): Uint8Array;
  getEndValueClosed_asB64(): string;
  setEndValueClosed(value: Uint8Array | string): void;

  getEndValueOpen(): Uint8Array | string;
  getEndValueOpen_asU8(): Uint8Array;
  getEndValueOpen_asB64(): string;
  setEndValueOpen(value: Uint8Array | string): void;
...
export namespace ValueRange {
  export type AsObject = {
    startValueClosed: Uint8Array | string,
    startValueOpen: Uint8Array | string,
    endValueClosed: Uint8Array | string,
    endValueOpen: Uint8Array | string,
  }
