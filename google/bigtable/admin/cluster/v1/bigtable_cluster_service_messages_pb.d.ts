...
export class ListZonesResponse extends jspb.Message {
  ...
  setZonesList(value: Array<google_bigtable_admin_cluster_v1_bigtable_cluster_data_pb.Zone>): void;
  clearZonesList(): void;
...
export class ListClustersResponse extends jspb.Message {
  ...
  setClustersList(value: Array<google_bigtable_admin_cluster_v1_bigtable_cluster_data_pb.Cluster>): void;
  ...
  setFailedZonesList(value: Array<google_bigtable_admin_cluster_v1_bigtable_cluster_data_pb.Zone>): void;
  clearFailedZonesList(): void;
...
export class CreateClusterRequest extends jspb.Message {
  ...
  setCluster(value?: google_bigtable_admin_cluster_v1_bigtable_cluster_data_pb.Cluster): void;
  hasCluster(): boolean;
  clearCluster(): void;
...
export class UpdateClusterMetadata extends jspb.Message {
  ...
  setOriginalRequest(value?: google_bigtable_admin_cluster_v1_bigtable_cluster_data_pb.Cluster): void;
  hasOriginalRequest(): boolean;
  clearOriginalRequest(): void;
