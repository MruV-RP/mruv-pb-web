...
export class ClusterManagerClient {
  ...
  methodInfoListUsableSubnetworks = new grpcWeb.AbstractClientBase.MethodInfo(
    ListUsableSubnetworksResponse,
    (request: ListUsableSubnetworksRequest) => {
      return request.serializeBinary();
    },
    ListUsableSubnetworksResponse.deserializeBinary
  );
  ...
  listUsableSubnetworks(
    ...
    metadata: grpcWeb.Metadata | null,
    callback: (err: grpcWeb.Error,
               response: ListUsableSubnetworksResponse) => void) {
    return this.client_.rpcCall(
      this.hostname_ +
        '/google.container.v1.ClusterManager/ListUsableSubnetworks',
      request,
      metadata || {},
      this.methodInfoListUsableSubnetworks,
      callback);
  }
