...
export class ReportStateAndNotificationRequest extends jspb.Message {
  ...
  setFollowUpToken(value: string): void;

  getPayload(): StateAndNotificationPayload | undefined;
  setPayload(value?: StateAndNotificationPayload): void;
  hasPayload(): boolean;
  clearPayload(): void;
...
export class StateAndNotificationPayload extends jspb.Message {
  ...
  setDevices(value?: ReportStateAndNotificationDevice): void;
  hasDevices(): boolean;
  clearDevices(): void;
...
export class ReportStateAndNotificationDevice extends jspb.Message {
  ...
  setStates(value?: google_protobuf_struct_pb.Struct): void;
  hasStates(): boolean;
  clearStates(): void;

  getNotifications(): google_protobuf_struct_pb.Struct | undefined;
  setNotifications(value?: google_protobuf_struct_pb.Struct): void;
...
export class QueryRequest extends jspb.Message {
  ...
  setInputsList(value: Array<QueryRequestInput>): void;
...
export class QueryRequestInput extends jspb.Message {
  ...
  setPayload(value?: QueryRequestPayload): void;
  hasPayload(): boolean;
  clearPayload(): void;
...
export class QueryRequestPayload extends jspb.Message {
  ...
  setDevicesList(value: Array<AgentDeviceId>): void;
...
export class QueryResponse extends jspb.Message {
  ...
  setPayload(value?: QueryResponsePayload): void;
  hasPayload(): boolean;
  clearPayload(): void;
...
export class SyncResponse extends jspb.Message {
  ...
  setPayload(value?: SyncResponsePayload): void;
  hasPayload(): boolean;
  clearPayload(): void;
...
export class SyncResponsePayload extends jspb.Message {
  ...
  setDevicesList(value: Array<google_home_graph_v1_device_pb.Device>): void;
  clearDevicesList(): void;
