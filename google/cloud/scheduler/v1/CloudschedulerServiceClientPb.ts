/**
 * @fileoverview gRPC-Web generated client stub for google.cloud.scheduler.v1
 * @enhanceable
 * @public
 */
...
export class CloudSchedulerClient {
  ...
  methodInfoGetJob = new grpcWeb.AbstractClientBase.MethodInfo(
    google_cloud_scheduler_v1_job_pb.Job,
    (request: GetJobRequest) => {
      return request.serializeBinary();
    },
    google_cloud_scheduler_v1_job_pb.Job.deserializeBinary
  );
  ...
  getJob(
    ...
    metadata: grpcWeb.Metadata | null,
    callback: (err: grpcWeb.Error,
               response: google_cloud_scheduler_v1_job_pb.Job) => void) {
    return this.client_.rpcCall(
      this.hostname_ +
