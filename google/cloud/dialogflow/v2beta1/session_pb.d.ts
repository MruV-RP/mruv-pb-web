...
export class DetectIntentRequest extends jspb.Message {
  ...
  setOutputAudioConfig(value?: google_cloud_dialogflow_v2beta1_audio_config_pb.OutputAudioConfig): void;
...
export class DetectIntentResponse extends jspb.Message {
  ...
  setAlternativeQueryResultsList(value: Array<QueryResult>): void;
...
export class QueryParameters extends jspb.Message {
  ...
  setContextsList(value: Array<google_cloud_dialogflow_v2beta1_context_pb.Context>): void;
  ...
  setKnowledgeBaseNamesList(value: Array<string>): void;
  clearKnowledgeBaseNamesList(): void;
  addKnowledgeBaseNames(value: string, index?: number): void;
  ...
  getWebhookHeadersMap(): jspb.Map<string, string>;
  clearWebhookHeadersMap(): void;
...
export namespace QueryParameters {
  export type AsObject = {
    ...
    webhookHeadersMap: Array<[string, string]>,
  }
}

export class QueryInput extends jspb.Message {
  getAudioConfig(): google_cloud_dialogflow_v2beta1_audio_config_pb.InputAudioConfig | undefined;
  setAudioConfig(value?: google_cloud_dialogflow_v2beta1_audio_config_pb.InputAudioConfig): void;
...
export namespace QueryInput {
  export type AsObject = {
    audioConfig?: google_cloud_dialogflow_v2beta1_audio_config_pb.InputAudioConfig.AsObject,
...
export class QueryResult extends jspb.Message {
  ...
  setIntent(value?: google_cloud_dialogflow_v2beta1_intent_pb.Intent): void;
  hasIntent(): boolean;
  clearIntent(): void;
  ...
  setKnowledgeAnswers(value?: KnowledgeAnswers): void;
  hasKnowledgeAnswers(): boolean;
  clearKnowledgeAnswers(): void;
...
export class KnowledgeAnswers extends jspb.Message {
  ...
  setAnswersList(value: Array<KnowledgeAnswers.Answer>): void;
...
export namespace KnowledgeAnswers {
  ...
  export class Answer extends jspb.Message {
    ...
    setMatchConfidenceLevel(value: KnowledgeAnswers.Answer.MatchConfidenceLevel): void;

    getMatchConfidence(): number;
    setMatchConfidence(value: number): void;
...
export class StreamingRecognitionResult extends jspb.Message {
  ...
  getSpeechWordInfoList(): Array<google_cloud_dialogflow_v2beta1_audio_config_pb.SpeechWordInfo>;
  setSpeechWordInfoList(value: Array<google_cloud_dialogflow_v2beta1_audio_config_pb.SpeechWordInfo>): void;
  clearSpeechWordInfoList(): void;
  addSpeechWordInfo(value?: google_cloud_dialogflow_v2beta1_audio_config_pb.SpeechWordInfo, index?: number): google_cloud_dialogflow_v2beta1_audio_config_pb.SpeechWordInfo;

  getSpeechEndOffset(): google_protobuf_duration_pb.Duration | undefined;
  setSpeechEndOffset(value?: google_protobuf_duration_pb.Duration): void;
  hasSpeechEndOffset(): boolean;
  clearSpeechEndOffset(): void;
...
export namespace StreamingRecognitionResult {
  export type AsObject = {
    ...
    confidence: number,
    stability: number,
    speechWordInfoList: Array<google_cloud_dialogflow_v2beta1_audio_config_pb.SpeechWordInfo.AsObject>,
    speechEndOffset?: google_protobuf_duration_pb.Duration.AsObject,
  }
