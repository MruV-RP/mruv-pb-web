...
export class SessionEntityType extends jspb.Message {
  ...
  setEntityOverrideMode(value: SessionEntityType.EntityOverrideMode): void;

  getEntitiesList(): Array<google_cloud_dialogflow_v2_entity_type_pb.EntityType.Entity>;
  setEntitiesList(value: Array<google_cloud_dialogflow_v2_entity_type_pb.EntityType.Entity>): void;
