...
export namespace ListAssetsResponse {
  ...
  export class ListAssetsResult extends jspb.Message {
    ...
    getState(): ListAssetsResponse.ListAssetsResult.State;
    setState(value: ListAssetsResponse.ListAssetsResult.State): void;
...
export class SetFindingStateRequest extends jspb.Message {
  ...
  getState(): google_cloud_securitycenter_v1beta1_finding_pb.Finding.State;
  setState(value: google_cloud_securitycenter_v1beta1_finding_pb.Finding.State): void;
...
export namespace SetFindingStateRequest {
  export type AsObject = {
    name: string,
    state: google_cloud_securitycenter_v1beta1_finding_pb.Finding.State,
