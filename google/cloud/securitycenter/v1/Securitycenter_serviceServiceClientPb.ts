/**
 * @fileoverview gRPC-Web generated client stub for google.cloud.securitycenter.v1
 * @enhanceable
 * @public
 */
...
export class SecurityCenterClient {
  ...
  methodInfoCreateSource = new grpcWeb.AbstractClientBase.MethodInfo(
    google_cloud_securitycenter_v1_source_pb.Source,
    (request: CreateSourceRequest) => {
      return request.serializeBinary();
    },
    google_cloud_securitycenter_v1_source_pb.Source.deserializeBinary
  );
  ...
  createSource(
    ...
    callback: (err: grpcWeb.Error,
               response: google_cloud_securitycenter_v1_source_pb.Source) => void) {
  ...
  methodInfoCreateFinding = new grpcWeb.AbstractClientBase.MethodInfo(
    google_cloud_securitycenter_v1_finding_pb.Finding,
    (request: CreateFindingRequest) => {
      return request.serializeBinary();
    },
    google_cloud_securitycenter_v1_finding_pb.Finding.deserializeBinary
  );
  ...
  createFinding(
    ...
    metadata: grpcWeb.Metadata | null,
    callback: (err: grpcWeb.Error,
               response: google_cloud_securitycenter_v1_finding_pb.Finding) => void) {
    return this.client_.rpcCall(
      this.hostname_ +
  ...
  methodInfoGetOrganizationSettings = new grpcWeb.AbstractClientBase.MethodInfo(
    google_cloud_securitycenter_v1_organization_settings_pb.OrganizationSettings,
    (request: GetOrganizationSettingsRequest) => {
      return request.serializeBinary();
    },
    google_cloud_securitycenter_v1_organization_settings_pb.OrganizationSettings.deserializeBinary
  );
  ...
  getOrganizationSettings(
    ...
    metadata: grpcWeb.Metadata | null,
    callback: (err: grpcWeb.Error,
               response: google_cloud_securitycenter_v1_organization_settings_pb.OrganizationSettings) => void) {
    return this.client_.rpcCall(
      this.hostname_ +
  ...
  methodInfoUpdateSecurityMarks = new grpcWeb.AbstractClientBase.MethodInfo(
    google_cloud_securitycenter_v1_security_marks_pb.SecurityMarks,
    (request: UpdateSecurityMarksRequest) => {
      return request.serializeBinary();
    },
    google_cloud_securitycenter_v1_security_marks_pb.SecurityMarks.deserializeBinary
  );
  ...
  updateSecurityMarks(
    ...
    metadata: grpcWeb.Metadata | null,
    callback: (err: grpcWeb.Error,
               response: google_cloud_securitycenter_v1_security_marks_pb.SecurityMarks) => void) {
    return this.client_.rpcCall(
      this.hostname_ +
