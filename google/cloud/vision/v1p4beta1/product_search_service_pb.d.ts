...
export class ReferenceImage extends jspb.Message {
  ...
  getBoundingPolysList(): Array<google_cloud_vision_v1p4beta1_geometry_pb.BoundingPoly>;
  setBoundingPolysList(value: Array<google_cloud_vision_v1p4beta1_geometry_pb.BoundingPoly>): void;
  clearBoundingPolysList(): void;
  addBoundingPolys(value?: google_cloud_vision_v1p4beta1_geometry_pb.BoundingPoly, index?: number): google_cloud_vision_v1p4beta1_geometry_pb.BoundingPoly;
...
export namespace ReferenceImage {
  export type AsObject = {
    name: string,
    uri: string,
    boundingPolysList: Array<google_cloud_vision_v1p4beta1_geometry_pb.BoundingPoly.AsObject>,
  }
}
