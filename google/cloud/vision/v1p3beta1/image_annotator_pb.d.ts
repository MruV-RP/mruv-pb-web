...
export class FaceAnnotation extends jspb.Message {
  ...
  setFdBoundingPoly(value?: google_cloud_vision_v1p3beta1_geometry_pb.BoundingPoly): void;
...
export namespace FaceAnnotation {
  ...
  export class Landmark extends jspb.Message {
    ...
    setPosition(value?: google_cloud_vision_v1p3beta1_geometry_pb.Position): void;
    hasPosition(): boolean;
    clearPosition(): void;
...
export class ImageContext extends jspb.Message {
  ...
  setProductSearchParams(value?: google_cloud_vision_v1p3beta1_product_search_pb.ProductSearchParams): void;
...
export class AnnotateImageResponse extends jspb.Message {
  ...
  setFullTextAnnotation(value?: google_cloud_vision_v1p3beta1_text_annotation_pb.TextAnnotation): void;
  ...
  setWebDetection(value?: google_cloud_vision_v1p3beta1_web_detection_pb.WebDetection): void;
  ...
  setProductSearchResults(value?: google_cloud_vision_v1p3beta1_product_search_pb.ProductSearchResults): void;
