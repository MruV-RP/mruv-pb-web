...
export class FaceAnnotation extends jspb.Message {
  getBoundingPoly(): google_cloud_vision_v1p2beta1_geometry_pb.BoundingPoly | undefined;
  setBoundingPoly(value?: google_cloud_vision_v1p2beta1_geometry_pb.BoundingPoly): void;
  hasBoundingPoly(): boolean;
  clearBoundingPoly(): void;

  getFdBoundingPoly(): google_cloud_vision_v1p2beta1_geometry_pb.BoundingPoly | undefined;
  setFdBoundingPoly(value?: google_cloud_vision_v1p2beta1_geometry_pb.BoundingPoly): void;
...
export namespace FaceAnnotation {
  export type AsObject = {
    boundingPoly?: google_cloud_vision_v1p2beta1_geometry_pb.BoundingPoly.AsObject,
    fdBoundingPoly?: google_cloud_vision_v1p2beta1_geometry_pb.BoundingPoly.AsObject,
  ...
  export class Landmark extends jspb.Message {
    ...
    getPosition(): google_cloud_vision_v1p2beta1_geometry_pb.Position | undefined;
    setPosition(value?: google_cloud_vision_v1p2beta1_geometry_pb.Position): void;
    hasPosition(): boolean;
    clearPosition(): void;
  ...
  export namespace Landmark {
    export type AsObject = {
      ...
      position?: google_cloud_vision_v1p2beta1_geometry_pb.Position.AsObject,
    }
...
export class AnnotateImageResponse extends jspb.Message {
  ...
  getFullTextAnnotation(): google_cloud_vision_v1p2beta1_text_annotation_pb.TextAnnotation | undefined;
  setFullTextAnnotation(value?: google_cloud_vision_v1p2beta1_text_annotation_pb.TextAnnotation): void;
  ...
  getWebDetection(): google_cloud_vision_v1p2beta1_web_detection_pb.WebDetection | undefined;
  setWebDetection(value?: google_cloud_vision_v1p2beta1_web_detection_pb.WebDetection): void;
...
export namespace AnnotateImageResponse {
  export type AsObject = {
    ...
    fullTextAnnotation?: google_cloud_vision_v1p2beta1_text_annotation_pb.TextAnnotation.AsObject,
    ...
    webDetection?: google_cloud_vision_v1p2beta1_web_detection_pb.WebDetection.AsObject,
