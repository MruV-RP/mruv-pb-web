...
export class SafeSearchAnnotation extends jspb.Message {
  ...
  getAdultConfidence(): number;
  setAdultConfidence(value: number): void;

  getSpoofConfidence(): number;
  setSpoofConfidence(value: number): void;

  getMedicalConfidence(): number;
  setMedicalConfidence(value: number): void;

  getViolenceConfidence(): number;
  setViolenceConfidence(value: number): void;

  getRacyConfidence(): number;
  setRacyConfidence(value: number): void;

  getNsfwConfidence(): number;
  setNsfwConfidence(value: number): void;
