...
export class Block extends jspb.Message {
  ...
  getBoundingBox(): google_cloud_vision_v1p1beta1_geometry_pb.BoundingPoly | undefined;
  setBoundingBox(value?: google_cloud_vision_v1p1beta1_geometry_pb.BoundingPoly): void;
...
export namespace Block {
  export type AsObject = {
    property?: TextAnnotation.TextProperty.AsObject,
    boundingBox?: google_cloud_vision_v1p1beta1_geometry_pb.BoundingPoly.AsObject,
