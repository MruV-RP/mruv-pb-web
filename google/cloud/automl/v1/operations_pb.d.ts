...
export class OperationMetadata extends jspb.Message {
  ...
  getCreateDatasetDetails(): CreateDatasetOperationMetadata | undefined;
  setCreateDatasetDetails(value?: CreateDatasetOperationMetadata): void;
  hasCreateDatasetDetails(): boolean;
  clearCreateDatasetDetails(): void;
...
export namespace OperationMetadata {
  export type AsObject = {
    ...
    createDatasetDetails?: CreateDatasetOperationMetadata.AsObject,
...
export class CreateDatasetOperationMetadata extends jspb.Message {
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): CreateDatasetOperationMetadata.AsObject;
  static toObject(includeInstance: boolean, msg: CreateDatasetOperationMetadata): CreateDatasetOperationMetadata.AsObject;
  static serializeBinaryToWriter(message: CreateDatasetOperationMetadata, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): CreateDatasetOperationMetadata;
  static deserializeBinaryFromReader(message: CreateDatasetOperationMetadata, reader: jspb.BinaryReader): CreateDatasetOperationMetadata;
}

export namespace CreateDatasetOperationMetadata {
  export type AsObject = {
  }
}
