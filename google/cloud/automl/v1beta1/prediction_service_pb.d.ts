...
export class PredictRequest extends jspb.Message {
  ...
  setPayload(value?: google_cloud_automl_v1beta1_data_items_pb.ExamplePayload): void;
  hasPayload(): boolean;
  clearPayload(): void;
...
export class PredictResponse extends jspb.Message {
  ...
  setPayloadList(value: Array<google_cloud_automl_v1beta1_annotation_payload_pb.AnnotationPayload>): void;
  ...
  getPreprocessedInput(): google_cloud_automl_v1beta1_data_items_pb.ExamplePayload | undefined;
  setPreprocessedInput(value?: google_cloud_automl_v1beta1_data_items_pb.ExamplePayload): void;
...
export namespace PredictResponse {
  export type AsObject = {
    ...
    preprocessedInput?: google_cloud_automl_v1beta1_data_items_pb.ExamplePayload.AsObject,
...
export class BatchPredictRequest extends jspb.Message {
  ...
  getOutputConfig(): google_cloud_automl_v1beta1_io_pb.BatchPredictOutputConfig | undefined;
  setOutputConfig(value?: google_cloud_automl_v1beta1_io_pb.BatchPredictOutputConfig): void;
...
export namespace BatchPredictRequest {
  export type AsObject = {
    ...
    outputConfig?: google_cloud_automl_v1beta1_io_pb.BatchPredictOutputConfig.AsObject,
    paramsMap: Array<[string, string]>,
  }
}
