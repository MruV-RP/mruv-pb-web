...
export class VideoClassificationAnnotation extends jspb.Message {
  ...
  getClassificationAnnotation(): ClassificationAnnotation | undefined;
  setClassificationAnnotation(value?: ClassificationAnnotation): void;
  hasClassificationAnnotation(): boolean;
  clearClassificationAnnotation(): void;

  getTimeSegment(): google_cloud_automl_v1beta1_temporal_pb.TimeSegment | undefined;
  setTimeSegment(value?: google_cloud_automl_v1beta1_temporal_pb.TimeSegment): void;
...
export namespace VideoClassificationAnnotation {
  export type AsObject = {
    type: string,
    classificationAnnotation?: ClassificationAnnotation.AsObject,
    timeSegment?: google_cloud_automl_v1beta1_temporal_pb.TimeSegment.AsObject,
  }
}
...
export class ClassificationEvaluationMetrics extends jspb.Message {
  ...
  getBaseAuPrc(): number;
  setBaseAuPrc(value: number): void;
