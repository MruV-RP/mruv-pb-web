...
goog.exportSymbol('proto.google.cloud.oslogin.common.OperatingSystemType', null, global);
...
proto.google.cloud.oslogin.common.PosixAccount.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    operatingSystemType: jspb.Message.getFieldWithDefault(msg, 10, 0),
...
proto.google.cloud.oslogin.common.PosixAccount.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 9:
      ...
      break;
    case 10:
      var value = /** @type {!proto.google.cloud.oslogin.common.OperatingSystemType} */ (reader.readEnum());
      msg.setOperatingSystemType(value);
      break;
    case 11:
      var value = /** @type {string} */ (reader.readString());
      msg.setName(value);
...
proto.google.cloud.oslogin.common.PosixAccount.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getOperatingSystemType();
  if (f !== 0.0) {
    writer.writeEnum(
      10,
      f
...
/**
 * optional OperatingSystemType operating_system_type = 10;
 * @return {!proto.google.cloud.oslogin.common.OperatingSystemType}
 */
proto.google.cloud.oslogin.common.PosixAccount.prototype.getOperatingSystemType = function() {
  return /** @type {!proto.google.cloud.oslogin.common.OperatingSystemType} */ (jspb.Message.getFieldWithDefault(this, 10, 0));
};


/** @param {!proto.google.cloud.oslogin.common.OperatingSystemType} value */
proto.google.cloud.oslogin.common.PosixAccount.prototype.setOperatingSystemType = function(value) {
 ...
 * @return {string}
 */
proto.google.cloud.oslogin.common.PosixAccount.prototype.getName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 11, ""));
};


/** @param {string} value */
proto.google.cloud.oslogin.common.PosixAccount.prototype.setName = function(value) {
 ...
 * @return {string}
 */
proto.google.cloud.oslogin.common.SshPublicKey.prototype.getName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 4, ""));
};


/** @param {string} value */
proto.google.cloud.oslogin.common.SshPublicKey.prototype.setName = function(value) {
 ...
 * @enum {number}
 */
proto.google.cloud.oslogin.common.OperatingSystemType = {
