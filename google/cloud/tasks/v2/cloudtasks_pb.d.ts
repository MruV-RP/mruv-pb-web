...
import * as google_cloud_tasks_v2_queue_pb from '../../../../google/cloud/tasks/v2/queue_pb';
import * as google_cloud_tasks_v2_task_pb from '../../../../google/cloud/tasks/v2/task_pb';
...
export class ListQueuesResponse extends jspb.Message {
  getQueuesList(): Array<google_cloud_tasks_v2_queue_pb.Queue>;
  setQueuesList(value: Array<google_cloud_tasks_v2_queue_pb.Queue>): void;
  clearQueuesList(): void;
  addQueues(value?: google_cloud_tasks_v2_queue_pb.Queue, index?: number): google_cloud_tasks_v2_queue_pb.Queue;
...
export namespace ListQueuesResponse {
  export type AsObject = {
    queuesList: Array<google_cloud_tasks_v2_queue_pb.Queue.AsObject>,
...
export class CreateQueueRequest extends jspb.Message {
  ...
  getQueue(): google_cloud_tasks_v2_queue_pb.Queue | undefined;
  setQueue(value?: google_cloud_tasks_v2_queue_pb.Queue): void;
  hasQueue(): boolean;
  clearQueue(): void;
...
export namespace CreateQueueRequest {
  export type AsObject = {
    parent: string,
    queue?: google_cloud_tasks_v2_queue_pb.Queue.AsObject,
  }
}
...
export class ListTasksRequest extends jspb.Message {
  ...
  getResponseView(): google_cloud_tasks_v2_task_pb.Task.View;
  setResponseView(value: google_cloud_tasks_v2_task_pb.Task.View): void;
...
export namespace ListTasksRequest {
  export type AsObject = {
    parent: string,
    responseView: google_cloud_tasks_v2_task_pb.Task.View,
    pageSize: number,
    pageToken: string,
  }
}
...
export class ListTasksResponse extends jspb.Message {
  getTasksList(): Array<google_cloud_tasks_v2_task_pb.Task>;
  setTasksList(value: Array<google_cloud_tasks_v2_task_pb.Task>): void;
  clearTasksList(): void;
  addTasks(value?: google_cloud_tasks_v2_task_pb.Task, index?: number): google_cloud_tasks_v2_task_pb.Task;
...
export namespace ListTasksResponse {
  export type AsObject = {
    tasksList: Array<google_cloud_tasks_v2_task_pb.Task.AsObject>,
    nextPageToken: string,
  }
}
...
export class CreateTaskRequest extends jspb.Message {
  ...
  getTask(): google_cloud_tasks_v2_task_pb.Task | undefined;
  setTask(value?: google_cloud_tasks_v2_task_pb.Task): void;
  hasTask(): boolean;
  clearTask(): void;
...
export namespace CreateTaskRequest {
  export type AsObject = {
    parent: string,
    task?: google_cloud_tasks_v2_task_pb.Task.AsObject,
    responseView: google_cloud_tasks_v2_task_pb.Task.View,
  }
}
