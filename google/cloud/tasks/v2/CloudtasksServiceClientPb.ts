/**
 * @fileoverview gRPC-Web generated client stub for google.cloud.tasks.v2
 * @enhanceable
 * @public
 */
...
export class CloudTasksClient {
  ...
  methodInfoGetQueue = new grpcWeb.AbstractClientBase.MethodInfo(
    google_cloud_tasks_v2_queue_pb.Queue,
    (request: GetQueueRequest) => {
      return request.serializeBinary();
    },
    google_cloud_tasks_v2_queue_pb.Queue.deserializeBinary
  );
  ...
  getQueue(
    ...
    metadata: grpcWeb.Metadata | null,
    callback: (err: grpcWeb.Error,
               response: google_cloud_tasks_v2_queue_pb.Queue) => void) {
    return this.client_.rpcCall(
      this.hostname_ +
  ...
  methodInfoGetTask = new grpcWeb.AbstractClientBase.MethodInfo(
    google_cloud_tasks_v2_task_pb.Task,
    (request: GetTaskRequest) => {
      return request.serializeBinary();
    },
    google_cloud_tasks_v2_task_pb.Task.deserializeBinary
  );
  ...
  getTask(
    ...
    metadata: grpcWeb.Metadata | null,
    callback: (err: grpcWeb.Error,
               response: google_cloud_tasks_v2_task_pb.Task) => void) {
    return this.client_.rpcCall(
      this.hostname_ +
