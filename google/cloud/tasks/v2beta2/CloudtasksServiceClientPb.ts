...
export class CloudTasksClient {
  ...
  getQueue(
    ...
    metadata: grpcWeb.Metadata | null,
    callback: (err: grpcWeb.Error,
               response: google_cloud_tasks_v2beta2_queue_pb.Queue) => void) {
    return this.client_.rpcCall(
      this.hostname_ +
  ...
  getTask(
    ...
    metadata: grpcWeb.Metadata | null,
    callback: (err: grpcWeb.Error,
               response: google_cloud_tasks_v2beta2_task_pb.Task) => void) {
    return this.client_.rpcCall(
      this.hostname_ +
  ...
  methodInfoLeaseTasks = new grpcWeb.AbstractClientBase.MethodInfo(
    LeaseTasksResponse,
    (request: LeaseTasksRequest) => {
      return request.serializeBinary();
    },
    LeaseTasksResponse.deserializeBinary
  );
  ...
  leaseTasks(
    ...
    metadata: grpcWeb.Metadata | null,
    callback: (err: grpcWeb.Error,
               response: LeaseTasksResponse) => void) {
    return this.client_.rpcCall(
      this.hostname_ +
        '/google.cloud.tasks.v2beta2.CloudTasks/LeaseTasks',
      request,
      metadata || {},
      this.methodInfoLeaseTasks,
      callback);
  }

  methodInfoAcknowledgeTask = new grpcWeb.AbstractClientBase.MethodInfo(
    google_protobuf_empty_pb.Empty,
  ...
  acknowledgeTask(
    ...
    return this.client_.rpcCall(
      ...
      request,
      metadata || {},
      this.methodInfoAcknowledgeTask,
      callback);
  }

  methodInfoRenewLease = new grpcWeb.AbstractClientBase.MethodInfo(
    google_cloud_tasks_v2beta2_task_pb.Task,
  ...
  renewLease(
    ...
    return this.client_.rpcCall(
      ...
      request,
      metadata || {},
      this.methodInfoRenewLease,
      callback);
  }

  methodInfoCancelLease = new grpcWeb.AbstractClientBase.MethodInfo(
    google_cloud_tasks_v2beta2_task_pb.Task,
