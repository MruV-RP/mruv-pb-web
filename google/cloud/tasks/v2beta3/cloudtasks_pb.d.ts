...
export class ListTasksRequest extends jspb.Message {
  ...
  getResponseView(): google_cloud_tasks_v2beta3_task_pb.Task.View;
  setResponseView(value: google_cloud_tasks_v2beta3_task_pb.Task.View): void;
...
export namespace ListTasksRequest {
  export type AsObject = {
    parent: string,
    responseView: google_cloud_tasks_v2beta3_task_pb.Task.View,
    pageSize: number,
    pageToken: string,
  }
}
