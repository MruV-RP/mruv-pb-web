...
export class CreateBudgetRequest extends jspb.Message {
  ...
  getBudget(): google_cloud_billing_budgets_v1alpha1_budget_model_pb.Budget | undefined;
  setBudget(value?: google_cloud_billing_budgets_v1alpha1_budget_model_pb.Budget): void;
  hasBudget(): boolean;
  clearBudget(): void;
...
export namespace CreateBudgetRequest {
  export type AsObject = {
    parent: string,
    budget?: google_cloud_billing_budgets_v1alpha1_budget_model_pb.Budget.AsObject,
  }
}
...
export class ListBudgetsResponse extends jspb.Message {
  getBudgetsList(): Array<google_cloud_billing_budgets_v1alpha1_budget_model_pb.Budget>;
  setBudgetsList(value: Array<google_cloud_billing_budgets_v1alpha1_budget_model_pb.Budget>): void;
  clearBudgetsList(): void;
  addBudgets(value?: google_cloud_billing_budgets_v1alpha1_budget_model_pb.Budget, index?: number): google_cloud_billing_budgets_v1alpha1_budget_model_pb.Budget;
...
export namespace ListBudgetsResponse {
  export type AsObject = {
    budgetsList: Array<google_cloud_billing_budgets_v1alpha1_budget_model_pb.Budget.AsObject>,
