/**
 * @fileoverview gRPC-Web generated client stub for google.cloud.billing.budgets.v1beta1
 * @enhanceable
 * @public
 */
...
export class BudgetServiceClient {
  ...
  methodInfoCreateBudget = new grpcWeb.AbstractClientBase.MethodInfo(
    google_cloud_billing_budgets_v1beta1_budget_model_pb.Budget,
    (request: CreateBudgetRequest) => {
      return request.serializeBinary();
    },
    google_cloud_billing_budgets_v1beta1_budget_model_pb.Budget.deserializeBinary
  );
  ...
  createBudget(
    ...
    callback: (err: grpcWeb.Error,
               response: google_cloud_billing_budgets_v1beta1_budget_model_pb.Budget) => void) {
