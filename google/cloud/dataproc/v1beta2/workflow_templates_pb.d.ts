...
export class ManagedCluster extends jspb.Message {
  ...
  setConfig(value?: google_cloud_dataproc_v1beta2_clusters_pb.ClusterConfig): void;
  hasConfig(): boolean;
  clearConfig(): void;
...
export class OrderedJob extends jspb.Message {
  ...
  setHadoopJob(value?: google_cloud_dataproc_v1beta2_jobs_pb.HadoopJob): void;
  hasHadoopJob(): boolean;
  clearHadoopJob(): void;

  getSparkJob(): google_cloud_dataproc_v1beta2_jobs_pb.SparkJob | undefined;
  setSparkJob(value?: google_cloud_dataproc_v1beta2_jobs_pb.SparkJob): void;
  hasSparkJob(): boolean;
  clearSparkJob(): void;

  getPysparkJob(): google_cloud_dataproc_v1beta2_jobs_pb.PySparkJob | undefined;
  setPysparkJob(value?: google_cloud_dataproc_v1beta2_jobs_pb.PySparkJob): void;
  hasPysparkJob(): boolean;
  clearPysparkJob(): void;

  getHiveJob(): google_cloud_dataproc_v1beta2_jobs_pb.HiveJob | undefined;
  setHiveJob(value?: google_cloud_dataproc_v1beta2_jobs_pb.HiveJob): void;
  hasHiveJob(): boolean;
  clearHiveJob(): void;

  getPigJob(): google_cloud_dataproc_v1beta2_jobs_pb.PigJob | undefined;
  setPigJob(value?: google_cloud_dataproc_v1beta2_jobs_pb.PigJob): void;
  hasPigJob(): boolean;
  clearPigJob(): void;

  getSparkSqlJob(): google_cloud_dataproc_v1beta2_jobs_pb.SparkSqlJob | undefined;
  setSparkSqlJob(value?: google_cloud_dataproc_v1beta2_jobs_pb.SparkSqlJob): void;
  ...
  setScheduling(value?: google_cloud_dataproc_v1beta2_jobs_pb.JobScheduling): void;
