...
export class SoftwareConfig extends jspb.Message {
  ...
  getOptionalComponentsList(): Array<google_cloud_dataproc_v1_shared_pb.Component>;
  setOptionalComponentsList(value: Array<google_cloud_dataproc_v1_shared_pb.Component>): void;
  clearOptionalComponentsList(): void;
  addOptionalComponents(value: google_cloud_dataproc_v1_shared_pb.Component, index?: number): void;
...
export namespace SoftwareConfig {
  export type AsObject = {
    ...
    optionalComponentsList: Array<google_cloud_dataproc_v1_shared_pb.Component>,
  }
}
