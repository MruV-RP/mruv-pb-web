...
export class ScanConfig extends jspb.Message {
  ...
  getExportToSecurityCommandCenter(): ScanConfig.ExportToSecurityCommandCenter;
  setExportToSecurityCommandCenter(value: ScanConfig.ExportToSecurityCommandCenter): void;

  getLatestRun(): google_cloud_websecurityscanner_v1beta_scan_run_pb.ScanRun | undefined;
  setLatestRun(value?: google_cloud_websecurityscanner_v1beta_scan_run_pb.ScanRun): void;
  hasLatestRun(): boolean;
  clearLatestRun(): void;

  getRiskLevel(): ScanConfig.RiskLevel;
  setRiskLevel(value: ScanConfig.RiskLevel): void;
...
export namespace ScanConfig {
  export type AsObject = {
    ...
    latestRun?: google_cloud_websecurityscanner_v1beta_scan_run_pb.ScanRun.AsObject,
  ...
  export enum ExportToSecurityCommandCenter { 
