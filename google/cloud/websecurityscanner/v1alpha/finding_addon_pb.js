...
goog.exportSymbol('proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders', null, global);
goog.exportSymbol('proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.Header', null, global);
 ...
 * @constructor
 */
proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.repeatedFields_, null);
};
goog.inherits(proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.displayName = 'proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.Header = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.Header, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.Header.displayName = 'proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.Header';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.repeatedFields_ = [1,2];
 ...
 * @return {!Object}
 */
proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.prototype.toObject = function(opt_includeInstance) {
  return proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.toObject = function(includeInstance, msg) {
  var f, obj = {
    headersList: jspb.Message.toObjectList(msg.getHeadersList(),
    proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.Header.toObject, includeInstance),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders}
 */
proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders;
  return proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders}
 */
proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = new proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.Header;
      reader.readMessage(value,proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.Header.deserializeBinaryFromReader);
 ...
 * @return {!Uint8Array}
 */
proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.Header.serializeBinaryToWriter
    );
  }
 ...
 * @return {!Object}
 */
proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.Header.prototype.toObject = function(opt_includeInstance) {
  return proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.Header.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.Header} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.Header.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.Header}
 */
proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.Header.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.Header;
  return proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.Header.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.Header} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.Header}
 */
proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.Header.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.Header.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.Header.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.Header} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.Header.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getName();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.Header.prototype.getName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};


/** @param {string} value */
proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.Header.prototype.setName = function(value) {
  jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.Header.prototype.getValue = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};


/** @param {string} value */
proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.Header.prototype.setValue = function(value) {
  jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {!Array<!proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.Header>}
 */
proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.prototype.getHeadersList = function() {
  return /** @type{!Array<!proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.Header>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.Header, 1));
};


/** @param {!Array<!proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.Header>} value */
proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.prototype.setHeadersList = function(value) {
  jspb.Message.setRepeatedWrapperField(this, 1, value);
};


/**
 * @param {!proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.Header=} opt_value
 * @param {number=} opt_index
 * @return {!proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.Header}
 */
proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.prototype.addHeaders = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.Header, opt_index);
};
 ...
 * Clears the list making it empty but non-null.
 */
proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.prototype.clearHeadersList = function() {
  this.setHeadersList([]);
};
 ...
 * @return {!Array<!proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.Header>}
 */
proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.prototype.getMissingHeadersList = function() {
  return /** @type{!Array<!proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.Header>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.Header, 2));
};


/** @param {!Array<!proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.Header>} value */
proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.prototype.setMissingHeadersList = function(value) {
 ...
 * @return {!proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.Header}
 */
proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.prototype.addMissingHeaders = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 2, opt_value, proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.Header, opt_index);
};
 ...
 * Clears the list making it empty but non-null.
 */
proto.google.cloud.websecurityscanner.v1alpha.VulnerableHeaders.prototype.clearMissingHeadersList = function() {
