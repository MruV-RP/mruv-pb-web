...
export class CreateScanConfigRequest extends jspb.Message {
  ...
  setScanConfig(value?: google_cloud_websecurityscanner_v1alpha_scan_config_pb.ScanConfig): void;
...
export class ListScanConfigsResponse extends jspb.Message {
  ...
  setScanConfigsList(value: Array<google_cloud_websecurityscanner_v1alpha_scan_config_pb.ScanConfig>): void;
...
export class ListScanRunsResponse extends jspb.Message {
  ...
  setScanRunsList(value: Array<google_cloud_websecurityscanner_v1alpha_scan_run_pb.ScanRun>): void;
...
export class ListCrawledUrlsResponse extends jspb.Message {
  ...
  setCrawledUrlsList(value: Array<google_cloud_websecurityscanner_v1alpha_crawled_url_pb.CrawledUrl>): void;
...
export class ListFindingsResponse extends jspb.Message {
  ...
  setFindingsList(value: Array<google_cloud_websecurityscanner_v1alpha_finding_pb.Finding>): void;
...
export class ListFindingTypeStatsResponse extends jspb.Message {
  ...
  setFindingTypeStatsList(value: Array<google_cloud_websecurityscanner_v1alpha_finding_type_stats_pb.FindingTypeStats>): void;
