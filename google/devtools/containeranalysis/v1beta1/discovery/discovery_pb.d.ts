...
export class Discovery extends jspb.Message {
  ...
  setAnalysisKind(value: google_devtools_containeranalysis_v1beta1_common_common_pb.NoteKind): void;
...
export class Discovered extends jspb.Message {
  ...
  setContinuousAnalysis(value: Discovered.ContinuousAnalysis): void;
  ...
  setAnalysisStatus(value: Discovered.AnalysisStatus): void;
