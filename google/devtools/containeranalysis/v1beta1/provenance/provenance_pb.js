...
var google_devtools_containeranalysis_v1beta1_source_source_pb = require('../../../../../google/devtools/containeranalysis/v1beta1/source/source_pb.js');
goog.object.extend(proto, google_devtools_containeranalysis_v1beta1_source_source_pb);
...
proto.grafeas.v1beta1.provenance.Source.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    context: (f = msg.getContext()) && google_devtools_containeranalysis_v1beta1_source_source_pb.SourceContext.toObject(includeInstance, f),
    additionalContextsList: jspb.Message.toObjectList(msg.getAdditionalContextsList(),
    google_devtools_containeranalysis_v1beta1_source_source_pb.SourceContext.toObject, includeInstance)
  };
...
proto.grafeas.v1beta1.provenance.Source.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      reader.readMessage(value, function(message, reader) {
        jspb.Map.deserializeBinary(message, reader, jspb.BinaryReader.prototype.readString, jspb.BinaryReader.prototype.readMessage, proto.grafeas.v1beta1.provenance.FileHashes.deserializeBinaryFromReader, "");
         });
      break;
    case 3:
      var value = new google_devtools_containeranalysis_v1beta1_source_source_pb.SourceContext;
      reader.readMessage(value,google_devtools_containeranalysis_v1beta1_source_source_pb.SourceContext.deserializeBinaryFromReader);
...
proto.grafeas.v1beta1.provenance.Source.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      3,
      f,
      google_devtools_containeranalysis_v1beta1_source_source_pb.SourceContext.serializeBinaryToWriter
    );
  }
...
proto.grafeas.v1beta1.provenance.Source.prototype.getContext = function() {
  return /** @type{?proto.grafeas.v1beta1.source.SourceContext} */ (
    jspb.Message.getWrapperField(this, google_devtools_containeranalysis_v1beta1_source_source_pb.SourceContext, 3));
};
...
proto.grafeas.v1beta1.provenance.Source.prototype.getAdditionalContextsList = function() {
  return /** @type{!Array<!proto.grafeas.v1beta1.source.SourceContext>} */ (
    jspb.Message.getRepeatedWrapperField(this, google_devtools_containeranalysis_v1beta1_source_source_pb.SourceContext, 4));
};
