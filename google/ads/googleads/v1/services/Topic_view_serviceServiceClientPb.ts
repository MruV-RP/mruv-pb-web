...
export class TopicViewServiceClient {
  ...
  methodInfoGetTopicView = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v1_resources_topic_view_pb.TopicView,
    (request: GetTopicViewRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v1_resources_topic_view_pb.TopicView.deserializeBinary
  );
  ...
  getTopicView(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v1_resources_topic_view_pb.TopicView) => void) {
