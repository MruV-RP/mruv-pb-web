...
export class AdGroupCriterionLabelServiceClient {
  ...
  methodInfoGetAdGroupCriterionLabel = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v1_resources_ad_group_criterion_label_pb.AdGroupCriterionLabel,
    (request: GetAdGroupCriterionLabelRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v1_resources_ad_group_criterion_label_pb.AdGroupCriterionLabel.deserializeBinary
  );
  ...
  getAdGroupCriterionLabel(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v1_resources_ad_group_criterion_label_pb.AdGroupCriterionLabel) => void) {
