...
export class ProductBiddingCategoryConstantServiceClient {
  ...
  methodInfoGetProductBiddingCategoryConstant = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v1_resources_product_bidding_category_constant_pb.ProductBiddingCategoryConstant,
    (request: GetProductBiddingCategoryConstantRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v1_resources_product_bidding_category_constant_pb.ProductBiddingCategoryConstant.deserializeBinary
  );
  ...
  getProductBiddingCategoryConstant(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v1_resources_product_bidding_category_constant_pb.ProductBiddingCategoryConstant) => void) {
