...
export class DomainCategoryServiceClient {
  ...
  methodInfoGetDomainCategory = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v1_resources_domain_category_pb.DomainCategory,
    (request: GetDomainCategoryRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v1_resources_domain_category_pb.DomainCategory.deserializeBinary
  );
  ...
  getDomainCategory(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v1_resources_domain_category_pb.DomainCategory) => void) {
