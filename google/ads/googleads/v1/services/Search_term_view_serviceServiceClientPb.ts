...
export class SearchTermViewServiceClient {
  ...
  methodInfoGetSearchTermView = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v1_resources_search_term_view_pb.SearchTermView,
    (request: GetSearchTermViewRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v1_resources_search_term_view_pb.SearchTermView.deserializeBinary
  );
  ...
  getSearchTermView(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v1_resources_search_term_view_pb.SearchTermView) => void) {
