...
export class CampaignFeedServiceClient {
  ...
  methodInfoGetCampaignFeed = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v1_resources_campaign_feed_pb.CampaignFeed,
    (request: GetCampaignFeedRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v1_resources_campaign_feed_pb.CampaignFeed.deserializeBinary
  );
  ...
  getCampaignFeed(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v1_resources_campaign_feed_pb.CampaignFeed) => void) {
