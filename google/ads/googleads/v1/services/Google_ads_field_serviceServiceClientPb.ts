...
export class GoogleAdsFieldServiceClient {
  ...
  methodInfoGetGoogleAdsField = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v1_resources_google_ads_field_pb.GoogleAdsField,
    (request: GetGoogleAdsFieldRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v1_resources_google_ads_field_pb.GoogleAdsField.deserializeBinary
  );
  ...
  getGoogleAdsField(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v1_resources_google_ads_field_pb.GoogleAdsField) => void) {
