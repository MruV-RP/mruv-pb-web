...
export class CampaignBudgetServiceClient {
  ...
  methodInfoGetCampaignBudget = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v1_resources_campaign_budget_pb.CampaignBudget,
    (request: GetCampaignBudgetRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v1_resources_campaign_budget_pb.CampaignBudget.deserializeBinary
  );
  ...
  getCampaignBudget(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v1_resources_campaign_budget_pb.CampaignBudget) => void) {
