...
export class GeoTargetConstantServiceClient {
  ...
  methodInfoGetGeoTargetConstant = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v1_resources_geo_target_constant_pb.GeoTargetConstant,
    (request: GetGeoTargetConstantRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v1_resources_geo_target_constant_pb.GeoTargetConstant.deserializeBinary
  );
  ...
  getGeoTargetConstant(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v1_resources_geo_target_constant_pb.GeoTargetConstant) => void) {
