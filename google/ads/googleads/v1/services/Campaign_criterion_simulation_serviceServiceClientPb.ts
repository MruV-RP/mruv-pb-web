...
export class CampaignCriterionSimulationServiceClient {
  ...
  methodInfoGetCampaignCriterionSimulation = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v1_resources_campaign_criterion_simulation_pb.CampaignCriterionSimulation,
    (request: GetCampaignCriterionSimulationRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v1_resources_campaign_criterion_simulation_pb.CampaignCriterionSimulation.deserializeBinary
  );
  ...
  getCampaignCriterionSimulation(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v1_resources_campaign_criterion_simulation_pb.CampaignCriterionSimulation) => void) {
