...
export class PaidOrganicSearchTermViewServiceClient {
  ...
  methodInfoGetPaidOrganicSearchTermView = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v1_resources_paid_organic_search_term_view_pb.PaidOrganicSearchTermView,
    (request: GetPaidOrganicSearchTermViewRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v1_resources_paid_organic_search_term_view_pb.PaidOrganicSearchTermView.deserializeBinary
  );
  ...
  getPaidOrganicSearchTermView(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v1_resources_paid_organic_search_term_view_pb.PaidOrganicSearchTermView) => void) {
