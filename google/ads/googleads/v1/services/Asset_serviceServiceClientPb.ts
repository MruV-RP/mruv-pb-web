...
export class AssetServiceClient {
  ...
  methodInfoGetAsset = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v1_resources_asset_pb.Asset,
    (request: GetAssetRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v1_resources_asset_pb.Asset.deserializeBinary
  );
  ...
  getAsset(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v1_resources_asset_pb.Asset) => void) {
