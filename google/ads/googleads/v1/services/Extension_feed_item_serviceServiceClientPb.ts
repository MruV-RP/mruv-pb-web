...
export class ExtensionFeedItemServiceClient {
  ...
  methodInfoGetExtensionFeedItem = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v1_resources_extension_feed_item_pb.ExtensionFeedItem,
    (request: GetExtensionFeedItemRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v1_resources_extension_feed_item_pb.ExtensionFeedItem.deserializeBinary
  );
  ...
  getExtensionFeedItem(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v1_resources_extension_feed_item_pb.ExtensionFeedItem) => void) {
