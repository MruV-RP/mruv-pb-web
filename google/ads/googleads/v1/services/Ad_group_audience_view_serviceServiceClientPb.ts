...
export class AdGroupAudienceViewServiceClient {
  ...
  methodInfoGetAdGroupAudienceView = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v1_resources_ad_group_audience_view_pb.AdGroupAudienceView,
    (request: GetAdGroupAudienceViewRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v1_resources_ad_group_audience_view_pb.AdGroupAudienceView.deserializeBinary
  );
  ...
  getAdGroupAudienceView(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v1_resources_ad_group_audience_view_pb.AdGroupAudienceView) => void) {
