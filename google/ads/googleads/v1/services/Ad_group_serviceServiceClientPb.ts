...
export class AdGroupServiceClient {
  ...
  methodInfoGetAdGroup = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v1_resources_ad_group_pb.AdGroup,
    (request: GetAdGroupRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v1_resources_ad_group_pb.AdGroup.deserializeBinary
  );
  ...
  getAdGroup(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v1_resources_ad_group_pb.AdGroup) => void) {
