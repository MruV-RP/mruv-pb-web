...
export class UserInterestServiceClient {
  ...
  methodInfoGetUserInterest = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v1_resources_user_interest_pb.UserInterest,
    (request: GetUserInterestRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v1_resources_user_interest_pb.UserInterest.deserializeBinary
  );
  ...
  getUserInterest(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v1_resources_user_interest_pb.UserInterest) => void) {
