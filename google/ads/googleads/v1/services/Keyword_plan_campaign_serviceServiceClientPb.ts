...
export class KeywordPlanCampaignServiceClient {
  ...
  methodInfoGetKeywordPlanCampaign = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v1_resources_keyword_plan_campaign_pb.KeywordPlanCampaign,
    (request: GetKeywordPlanCampaignRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v1_resources_keyword_plan_campaign_pb.KeywordPlanCampaign.deserializeBinary
  );
  ...
  getKeywordPlanCampaign(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v1_resources_keyword_plan_campaign_pb.KeywordPlanCampaign) => void) {
