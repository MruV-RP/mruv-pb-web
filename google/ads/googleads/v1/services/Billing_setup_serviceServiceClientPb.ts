...
export class BillingSetupServiceClient {
  ...
  methodInfoGetBillingSetup = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v1_resources_billing_setup_pb.BillingSetup,
    (request: GetBillingSetupRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v1_resources_billing_setup_pb.BillingSetup.deserializeBinary
  );
  ...
  getBillingSetup(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v1_resources_billing_setup_pb.BillingSetup) => void) {
