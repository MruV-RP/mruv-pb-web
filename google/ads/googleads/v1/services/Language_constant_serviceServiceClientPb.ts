...
export class LanguageConstantServiceClient {
  ...
  methodInfoGetLanguageConstant = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v1_resources_language_constant_pb.LanguageConstant,
    (request: GetLanguageConstantRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v1_resources_language_constant_pb.LanguageConstant.deserializeBinary
  );
  ...
  getLanguageConstant(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v1_resources_language_constant_pb.LanguageConstant) => void) {
