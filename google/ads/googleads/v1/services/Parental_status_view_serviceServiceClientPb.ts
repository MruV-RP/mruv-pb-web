...
export class ParentalStatusViewServiceClient {
  ...
  methodInfoGetParentalStatusView = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v1_resources_parental_status_view_pb.ParentalStatusView,
    (request: GetParentalStatusViewRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v1_resources_parental_status_view_pb.ParentalStatusView.deserializeBinary
  );
  ...
  getParentalStatusView(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v1_resources_parental_status_view_pb.ParentalStatusView) => void) {
