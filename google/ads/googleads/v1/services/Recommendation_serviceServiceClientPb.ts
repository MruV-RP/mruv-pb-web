...
export class RecommendationServiceClient {
  ...
  methodInfoGetRecommendation = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v1_resources_recommendation_pb.Recommendation,
    (request: GetRecommendationRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v1_resources_recommendation_pb.Recommendation.deserializeBinary
  );
  ...
  getRecommendation(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v1_resources_recommendation_pb.Recommendation) => void) {
