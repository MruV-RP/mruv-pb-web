...
export class CampaignCriterionServiceClient {
  ...
  methodInfoGetCampaignCriterion = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v1_resources_campaign_criterion_pb.CampaignCriterion,
    (request: GetCampaignCriterionRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v1_resources_campaign_criterion_pb.CampaignCriterion.deserializeBinary
  );
  ...
  getCampaignCriterion(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v1_resources_campaign_criterion_pb.CampaignCriterion) => void) {
