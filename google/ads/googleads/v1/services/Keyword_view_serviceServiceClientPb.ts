...
export class KeywordViewServiceClient {
  ...
  methodInfoGetKeywordView = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v1_resources_keyword_view_pb.KeywordView,
    (request: GetKeywordViewRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v1_resources_keyword_view_pb.KeywordView.deserializeBinary
  );
  ...
  getKeywordView(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v1_resources_keyword_view_pb.KeywordView) => void) {
