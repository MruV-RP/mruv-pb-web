...
export class FeedServiceClient {
  ...
  methodInfoGetFeed = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v1_resources_feed_pb.Feed,
    (request: GetFeedRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v1_resources_feed_pb.Feed.deserializeBinary
  );
  ...
  getFeed(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v1_resources_feed_pb.Feed) => void) {
