...
export class AccountBudgetServiceClient {
  ...
  methodInfoGetAccountBudget = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v1_resources_account_budget_pb.AccountBudget,
    (request: GetAccountBudgetRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v1_resources_account_budget_pb.AccountBudget.deserializeBinary
  );
  ...
  getAccountBudget(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v1_resources_account_budget_pb.AccountBudget) => void) {
