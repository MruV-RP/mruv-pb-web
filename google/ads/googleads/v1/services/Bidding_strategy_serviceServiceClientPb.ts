...
export class BiddingStrategyServiceClient {
  ...
  methodInfoGetBiddingStrategy = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v1_resources_bidding_strategy_pb.BiddingStrategy,
    (request: GetBiddingStrategyRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v1_resources_bidding_strategy_pb.BiddingStrategy.deserializeBinary
  );
  ...
  getBiddingStrategy(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v1_resources_bidding_strategy_pb.BiddingStrategy) => void) {
