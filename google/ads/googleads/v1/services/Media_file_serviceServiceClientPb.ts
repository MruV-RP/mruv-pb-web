...
export class MediaFileServiceClient {
  ...
  methodInfoGetMediaFile = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v1_resources_media_file_pb.MediaFile,
    (request: GetMediaFileRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v1_resources_media_file_pb.MediaFile.deserializeBinary
  );
  ...
  getMediaFile(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v1_resources_media_file_pb.MediaFile) => void) {
