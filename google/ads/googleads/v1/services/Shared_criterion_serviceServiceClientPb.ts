...
export class SharedCriterionServiceClient {
  ...
  methodInfoGetSharedCriterion = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v1_resources_shared_criterion_pb.SharedCriterion,
    (request: GetSharedCriterionRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v1_resources_shared_criterion_pb.SharedCriterion.deserializeBinary
  );
  ...
  getSharedCriterion(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v1_resources_shared_criterion_pb.SharedCriterion) => void) {
