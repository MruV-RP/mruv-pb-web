...
export class CustomerServiceClient {
  ...
  methodInfoGetCustomer = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v1_resources_customer_pb.Customer,
    (request: GetCustomerRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v1_resources_customer_pb.Customer.deserializeBinary
  );
  ...
  getCustomer(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v1_resources_customer_pb.Customer) => void) {
