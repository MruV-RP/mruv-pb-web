...
export class FeedMappingServiceClient {
  ...
  methodInfoGetFeedMapping = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v1_resources_feed_mapping_pb.FeedMapping,
    (request: GetFeedMappingRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v1_resources_feed_mapping_pb.FeedMapping.deserializeBinary
  );
  ...
  getFeedMapping(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v1_resources_feed_mapping_pb.FeedMapping) => void) {
