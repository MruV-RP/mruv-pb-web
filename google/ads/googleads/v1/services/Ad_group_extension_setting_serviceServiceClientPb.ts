...
export class AdGroupExtensionSettingServiceClient {
  ...
  methodInfoGetAdGroupExtensionSetting = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v1_resources_ad_group_extension_setting_pb.AdGroupExtensionSetting,
    (request: GetAdGroupExtensionSettingRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v1_resources_ad_group_extension_setting_pb.AdGroupExtensionSetting.deserializeBinary
  );
  ...
  getAdGroupExtensionSetting(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v1_resources_ad_group_extension_setting_pb.AdGroupExtensionSetting) => void) {
