...
export class UserListServiceClient {
  ...
  methodInfoGetUserList = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v1_resources_user_list_pb.UserList,
    (request: GetUserListRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v1_resources_user_list_pb.UserList.deserializeBinary
  );
  ...
  getUserList(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v1_resources_user_list_pb.UserList) => void) {
