...
export class KeywordPlanAdGroupServiceClient {
  ...
  methodInfoGetKeywordPlanAdGroup = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v1_resources_keyword_plan_ad_group_pb.KeywordPlanAdGroup,
    (request: GetKeywordPlanAdGroupRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v1_resources_keyword_plan_ad_group_pb.KeywordPlanAdGroup.deserializeBinary
  );
  ...
  getKeywordPlanAdGroup(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v1_resources_keyword_plan_ad_group_pb.KeywordPlanAdGroup) => void) {
