...
export class SharedSetServiceClient {
  ...
  methodInfoGetSharedSet = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v1_resources_shared_set_pb.SharedSet,
    (request: GetSharedSetRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v1_resources_shared_set_pb.SharedSet.deserializeBinary
  );
  ...
  getSharedSet(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v1_resources_shared_set_pb.SharedSet) => void) {
