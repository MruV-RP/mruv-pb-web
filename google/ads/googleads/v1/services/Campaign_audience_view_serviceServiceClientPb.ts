...
export class CampaignAudienceViewServiceClient {
  ...
  methodInfoGetCampaignAudienceView = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v1_resources_campaign_audience_view_pb.CampaignAudienceView,
    (request: GetCampaignAudienceViewRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v1_resources_campaign_audience_view_pb.CampaignAudienceView.deserializeBinary
  );
  ...
  getCampaignAudienceView(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v1_resources_campaign_audience_view_pb.CampaignAudienceView) => void) {
