...
export class LocationViewServiceClient {
  ...
  methodInfoGetLocationView = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v1_resources_location_view_pb.LocationView,
    (request: GetLocationViewRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v1_resources_location_view_pb.LocationView.deserializeBinary
  );
  ...
  getLocationView(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v1_resources_location_view_pb.LocationView) => void) {
