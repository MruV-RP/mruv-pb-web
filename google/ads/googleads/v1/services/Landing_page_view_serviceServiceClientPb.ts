...
export class LandingPageViewServiceClient {
  ...
  methodInfoGetLandingPageView = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v1_resources_landing_page_view_pb.LandingPageView,
    (request: GetLandingPageViewRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v1_resources_landing_page_view_pb.LandingPageView.deserializeBinary
  );
  ...
  getLandingPageView(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v1_resources_landing_page_view_pb.LandingPageView) => void) {
