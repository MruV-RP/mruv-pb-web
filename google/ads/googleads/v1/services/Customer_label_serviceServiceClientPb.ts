...
export class CustomerLabelServiceClient {
  ...
  methodInfoGetCustomerLabel = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v1_resources_customer_label_pb.CustomerLabel,
    (request: GetCustomerLabelRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v1_resources_customer_label_pb.CustomerLabel.deserializeBinary
  );
  ...
  getCustomerLabel(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v1_resources_customer_label_pb.CustomerLabel) => void) {
