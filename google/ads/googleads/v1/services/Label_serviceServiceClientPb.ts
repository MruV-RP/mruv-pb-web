...
export class LabelServiceClient {
  ...
  methodInfoGetLabel = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v1_resources_label_pb.Label,
    (request: GetLabelRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v1_resources_label_pb.Label.deserializeBinary
  );
  ...
  getLabel(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v1_resources_label_pb.Label) => void) {
