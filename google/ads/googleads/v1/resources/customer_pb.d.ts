...
export class Customer extends jspb.Message {
  ...
  addPayPerConversionEligibilityFailureReasons(value: google_ads_googleads_v1_enums_customer_pay_per_conversion_eligibility_failure_reason_pb.CustomerPayPerConversionEligibilityFailureReasonEnum.CustomerPayPerConversionEligibilityFailureReason, index?: number): void;
