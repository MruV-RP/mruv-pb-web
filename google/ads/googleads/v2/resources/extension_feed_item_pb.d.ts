...
export class ExtensionFeedItem extends jspb.Message {
  ...
  getHotelCalloutFeedItem(): google_ads_googleads_v2_common_extensions_pb.HotelCalloutFeedItem | undefined;
  setHotelCalloutFeedItem(value?: google_ads_googleads_v2_common_extensions_pb.HotelCalloutFeedItem): void;
...
export namespace ExtensionFeedItem {
  export type AsObject = {
    ...
    hotelCalloutFeedItem?: google_ads_googleads_v2_common_extensions_pb.HotelCalloutFeedItem.AsObject,
