...
export class ErrorCode extends jspb.Message {
  ...
  getReachPlanError(): google_ads_googleads_v2_errors_reach_plan_error_pb.ReachPlanErrorEnum.ReachPlanError;
  setReachPlanError(value: google_ads_googleads_v2_errors_reach_plan_error_pb.ReachPlanErrorEnum.ReachPlanError): void;

  getInvoiceError(): google_ads_googleads_v2_errors_invoice_error_pb.InvoiceErrorEnum.InvoiceError;
  setInvoiceError(value: google_ads_googleads_v2_errors_invoice_error_pb.InvoiceErrorEnum.InvoiceError): void;
...
export namespace ErrorCode {
  export type AsObject = {
    ...
    reachPlanError: google_ads_googleads_v2_errors_reach_plan_error_pb.ReachPlanErrorEnum.ReachPlanError,
    invoiceError: google_ads_googleads_v2_errors_invoice_error_pb.InvoiceErrorEnum.InvoiceError,
  }
