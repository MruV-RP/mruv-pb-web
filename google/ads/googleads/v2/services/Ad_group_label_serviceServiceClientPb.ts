...
export class AdGroupLabelServiceClient {
  ...
  methodInfoGetAdGroupLabel = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v2_resources_ad_group_label_pb.AdGroupLabel,
    (request: GetAdGroupLabelRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v2_resources_ad_group_label_pb.AdGroupLabel.deserializeBinary
  );
  ...
  getAdGroupLabel(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v2_resources_ad_group_label_pb.AdGroupLabel) => void) {
