...
export class RemarketingActionServiceClient {
  ...
  methodInfoGetRemarketingAction = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v2_resources_remarketing_action_pb.RemarketingAction,
    (request: GetRemarketingActionRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v2_resources_remarketing_action_pb.RemarketingAction.deserializeBinary
  );
  ...
  getRemarketingAction(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v2_resources_remarketing_action_pb.RemarketingAction) => void) {
