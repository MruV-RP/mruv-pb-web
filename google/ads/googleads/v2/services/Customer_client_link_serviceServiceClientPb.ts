...
export class CustomerClientLinkServiceClient {
  ...
  methodInfoGetCustomerClientLink = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v2_resources_customer_client_link_pb.CustomerClientLink,
    (request: GetCustomerClientLinkRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v2_resources_customer_client_link_pb.CustomerClientLink.deserializeBinary
  );
  ...
  getCustomerClientLink(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v2_resources_customer_client_link_pb.CustomerClientLink) => void) {
