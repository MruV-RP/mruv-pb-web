...
export class DisplayKeywordViewServiceClient {
  ...
  methodInfoGetDisplayKeywordView = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v2_resources_display_keyword_view_pb.DisplayKeywordView,
    (request: GetDisplayKeywordViewRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v2_resources_display_keyword_view_pb.DisplayKeywordView.deserializeBinary
  );
  ...
  getDisplayKeywordView(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v2_resources_display_keyword_view_pb.DisplayKeywordView) => void) {
