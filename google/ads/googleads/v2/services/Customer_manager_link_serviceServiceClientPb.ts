...
export class CustomerManagerLinkServiceClient {
  ...
  methodInfoGetCustomerManagerLink = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v2_resources_customer_manager_link_pb.CustomerManagerLink,
    (request: GetCustomerManagerLinkRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v2_resources_customer_manager_link_pb.CustomerManagerLink.deserializeBinary
  );
  ...
  getCustomerManagerLink(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v2_resources_customer_manager_link_pb.CustomerManagerLink) => void) {
