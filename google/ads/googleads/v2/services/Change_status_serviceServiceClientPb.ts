...
export class ChangeStatusServiceClient {
  ...
  methodInfoGetChangeStatus = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v2_resources_change_status_pb.ChangeStatus,
    (request: GetChangeStatusRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v2_resources_change_status_pb.ChangeStatus.deserializeBinary
  );
  ...
  getChangeStatus(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v2_resources_change_status_pb.ChangeStatus) => void) {
