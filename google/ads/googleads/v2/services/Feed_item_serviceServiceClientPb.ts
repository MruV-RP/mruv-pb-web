...
export class FeedItemServiceClient {
  ...
  methodInfoGetFeedItem = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v2_resources_feed_item_pb.FeedItem,
    (request: GetFeedItemRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v2_resources_feed_item_pb.FeedItem.deserializeBinary
  );
  ...
  getFeedItem(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v2_resources_feed_item_pb.FeedItem) => void) {
