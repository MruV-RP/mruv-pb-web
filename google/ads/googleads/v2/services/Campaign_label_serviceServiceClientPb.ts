...
export class CampaignLabelServiceClient {
  ...
  methodInfoGetCampaignLabel = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v2_resources_campaign_label_pb.CampaignLabel,
    (request: GetCampaignLabelRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v2_resources_campaign_label_pb.CampaignLabel.deserializeBinary
  );
  ...
  getCampaignLabel(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v2_resources_campaign_label_pb.CampaignLabel) => void) {
