...
export class CampaignSharedSetServiceClient {
  ...
  methodInfoGetCampaignSharedSet = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v2_resources_campaign_shared_set_pb.CampaignSharedSet,
    (request: GetCampaignSharedSetRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v2_resources_campaign_shared_set_pb.CampaignSharedSet.deserializeBinary
  );
  ...
  getCampaignSharedSet(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v2_resources_campaign_shared_set_pb.CampaignSharedSet) => void) {
