...
export class ClickViewServiceClient {
  ...
  methodInfoGetClickView = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v2_resources_click_view_pb.ClickView,
    (request: GetClickViewRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v2_resources_click_view_pb.ClickView.deserializeBinary
  );
  ...
  getClickView(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v2_resources_click_view_pb.ClickView) => void) {
