...
export class CampaignDraftServiceClient {
  ...
  methodInfoGetCampaignDraft = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v2_resources_campaign_draft_pb.CampaignDraft,
    (request: GetCampaignDraftRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v2_resources_campaign_draft_pb.CampaignDraft.deserializeBinary
  );
  ...
  getCampaignDraft(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v2_resources_campaign_draft_pb.CampaignDraft) => void) {
