...
export class MutateJobServiceClient {
  ...
  methodInfoGetMutateJob = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v2_resources_mutate_job_pb.MutateJob,
    (request: GetMutateJobRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v2_resources_mutate_job_pb.MutateJob.deserializeBinary
  );
  ...
  getMutateJob(
    ...
    metadata: grpcWeb.Metadata | null,
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v2_resources_mutate_job_pb.MutateJob) => void) {
    return this.client_.rpcCall(
      this.hostname_ +
