...
export class GeographicViewServiceClient {
  ...
  methodInfoGetGeographicView = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v2_resources_geographic_view_pb.GeographicView,
    (request: GetGeographicViewRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v2_resources_geographic_view_pb.GeographicView.deserializeBinary
  );
  ...
  getGeographicView(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v2_resources_geographic_view_pb.GeographicView) => void) {
