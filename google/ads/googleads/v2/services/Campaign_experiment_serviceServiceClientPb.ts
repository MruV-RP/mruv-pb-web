...
export class CampaignExperimentServiceClient {
  ...
  methodInfoGetCampaignExperiment = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v2_resources_campaign_experiment_pb.CampaignExperiment,
    (request: GetCampaignExperimentRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v2_resources_campaign_experiment_pb.CampaignExperiment.deserializeBinary
  );
  ...
  getCampaignExperiment(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v2_resources_campaign_experiment_pb.CampaignExperiment) => void) {
