...
export class KeywordPlanKeywordServiceClient {
  ...
  methodInfoGetKeywordPlanKeyword = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v2_resources_keyword_plan_keyword_pb.KeywordPlanKeyword,
    (request: GetKeywordPlanKeywordRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v2_resources_keyword_plan_keyword_pb.KeywordPlanKeyword.deserializeBinary
  );
  ...
  getKeywordPlanKeyword(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v2_resources_keyword_plan_keyword_pb.KeywordPlanKeyword) => void) {
