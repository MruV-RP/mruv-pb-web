...
export class KeywordPlanNegativeKeywordServiceClient {
  ...
  methodInfoGetKeywordPlanNegativeKeyword = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v2_resources_keyword_plan_negative_keyword_pb.KeywordPlanNegativeKeyword,
    (request: GetKeywordPlanNegativeKeywordRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v2_resources_keyword_plan_negative_keyword_pb.KeywordPlanNegativeKeyword.deserializeBinary
  );
  ...
  getKeywordPlanNegativeKeyword(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v2_resources_keyword_plan_negative_keyword_pb.KeywordPlanNegativeKeyword) => void) {
