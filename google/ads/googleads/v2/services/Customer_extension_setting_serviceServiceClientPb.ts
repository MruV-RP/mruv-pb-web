...
export class CustomerExtensionSettingServiceClient {
  ...
  methodInfoGetCustomerExtensionSetting = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v2_resources_customer_extension_setting_pb.CustomerExtensionSetting,
    (request: GetCustomerExtensionSettingRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v2_resources_customer_extension_setting_pb.CustomerExtensionSetting.deserializeBinary
  );
  ...
  getCustomerExtensionSetting(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v2_resources_customer_extension_setting_pb.CustomerExtensionSetting) => void) {
