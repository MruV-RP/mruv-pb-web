...
export class AdParameterServiceClient {
  ...
  methodInfoGetAdParameter = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v2_resources_ad_parameter_pb.AdParameter,
    (request: GetAdParameterRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v2_resources_ad_parameter_pb.AdParameter.deserializeBinary
  );
  ...
  getAdParameter(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v2_resources_ad_parameter_pb.AdParameter) => void) {
