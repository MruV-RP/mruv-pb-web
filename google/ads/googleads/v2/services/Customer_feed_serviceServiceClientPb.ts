...
export class CustomerFeedServiceClient {
  ...
  methodInfoGetCustomerFeed = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v2_resources_customer_feed_pb.CustomerFeed,
    (request: GetCustomerFeedRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v2_resources_customer_feed_pb.CustomerFeed.deserializeBinary
  );
  ...
  getCustomerFeed(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v2_resources_customer_feed_pb.CustomerFeed) => void) {
