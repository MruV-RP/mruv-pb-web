...
export class AdGroupCriterionSimulationServiceClient {
  ...
  methodInfoGetAdGroupCriterionSimulation = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v2_resources_ad_group_criterion_simulation_pb.AdGroupCriterionSimulation,
    (request: GetAdGroupCriterionSimulationRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v2_resources_ad_group_criterion_simulation_pb.AdGroupCriterionSimulation.deserializeBinary
  );
  ...
  getAdGroupCriterionSimulation(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v2_resources_ad_group_criterion_simulation_pb.AdGroupCriterionSimulation) => void) {
