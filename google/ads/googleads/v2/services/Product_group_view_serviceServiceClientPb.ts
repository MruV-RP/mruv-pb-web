...
export class ProductGroupViewServiceClient {
  ...
  methodInfoGetProductGroupView = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v2_resources_product_group_view_pb.ProductGroupView,
    (request: GetProductGroupViewRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v2_resources_product_group_view_pb.ProductGroupView.deserializeBinary
  );
  ...
  getProductGroupView(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v2_resources_product_group_view_pb.ProductGroupView) => void) {
