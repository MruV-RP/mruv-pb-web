...
export class CarrierConstantServiceClient {
  ...
  methodInfoGetCarrierConstant = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v2_resources_carrier_constant_pb.CarrierConstant,
    (request: GetCarrierConstantRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v2_resources_carrier_constant_pb.CarrierConstant.deserializeBinary
  );
  ...
  getCarrierConstant(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v2_resources_carrier_constant_pb.CarrierConstant) => void) {
