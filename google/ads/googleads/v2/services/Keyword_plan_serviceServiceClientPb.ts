...
export class KeywordPlanServiceClient {
  ...
  methodInfoGetKeywordPlan = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v2_resources_keyword_plan_pb.KeywordPlan,
    (request: GetKeywordPlanRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v2_resources_keyword_plan_pb.KeywordPlan.deserializeBinary
  );
  ...
  getKeywordPlan(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v2_resources_keyword_plan_pb.KeywordPlan) => void) {
