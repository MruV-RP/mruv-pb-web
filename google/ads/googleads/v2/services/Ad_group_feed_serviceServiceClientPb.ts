...
export class AdGroupFeedServiceClient {
  ...
  methodInfoGetAdGroupFeed = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v2_resources_ad_group_feed_pb.AdGroupFeed,
    (request: GetAdGroupFeedRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v2_resources_ad_group_feed_pb.AdGroupFeed.deserializeBinary
  );
  ...
  getAdGroupFeed(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v2_resources_ad_group_feed_pb.AdGroupFeed) => void) {
