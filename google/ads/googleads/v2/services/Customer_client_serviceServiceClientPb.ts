...
export class CustomerClientServiceClient {
  ...
  methodInfoGetCustomerClient = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v2_resources_customer_client_pb.CustomerClient,
    (request: GetCustomerClientRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v2_resources_customer_client_pb.CustomerClient.deserializeBinary
  );
  ...
  getCustomerClient(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v2_resources_customer_client_pb.CustomerClient) => void) {
