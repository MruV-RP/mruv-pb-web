...
export class MobileDeviceConstantServiceClient {
  ...
  methodInfoGetMobileDeviceConstant = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v2_resources_mobile_device_constant_pb.MobileDeviceConstant,
    (request: GetMobileDeviceConstantRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v2_resources_mobile_device_constant_pb.MobileDeviceConstant.deserializeBinary
  );
  ...
  getMobileDeviceConstant(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v2_resources_mobile_device_constant_pb.MobileDeviceConstant) => void) {
