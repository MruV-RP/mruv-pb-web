...
export class ShoppingPerformanceViewServiceClient {
  ...
  methodInfoGetShoppingPerformanceView = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v2_resources_shopping_performance_view_pb.ShoppingPerformanceView,
    (request: GetShoppingPerformanceViewRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v2_resources_shopping_performance_view_pb.ShoppingPerformanceView.deserializeBinary
  );
  ...
  getShoppingPerformanceView(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v2_resources_shopping_performance_view_pb.ShoppingPerformanceView) => void) {
