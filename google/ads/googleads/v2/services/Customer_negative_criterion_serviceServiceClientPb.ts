...
export class CustomerNegativeCriterionServiceClient {
  ...
  methodInfoGetCustomerNegativeCriterion = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v2_resources_customer_negative_criterion_pb.CustomerNegativeCriterion,
    (request: GetCustomerNegativeCriterionRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v2_resources_customer_negative_criterion_pb.CustomerNegativeCriterion.deserializeBinary
  );
  ...
  getCustomerNegativeCriterion(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v2_resources_customer_negative_criterion_pb.CustomerNegativeCriterion) => void) {
