...
export class HotelPerformanceViewServiceClient {
  ...
  methodInfoGetHotelPerformanceView = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v2_resources_hotel_performance_view_pb.HotelPerformanceView,
    (request: GetHotelPerformanceViewRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v2_resources_hotel_performance_view_pb.HotelPerformanceView.deserializeBinary
  );
  ...
  getHotelPerformanceView(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v2_resources_hotel_performance_view_pb.HotelPerformanceView) => void) {
