...
export class AdGroupSimulationServiceClient {
  ...
  methodInfoGetAdGroupSimulation = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v2_resources_ad_group_simulation_pb.AdGroupSimulation,
    (request: GetAdGroupSimulationRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v2_resources_ad_group_simulation_pb.AdGroupSimulation.deserializeBinary
  );
  ...
  getAdGroupSimulation(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v2_resources_ad_group_simulation_pb.AdGroupSimulation) => void) {
