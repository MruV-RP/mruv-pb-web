...
export class CustomInterestServiceClient {
  ...
  methodInfoGetCustomInterest = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v2_resources_custom_interest_pb.CustomInterest,
    (request: GetCustomInterestRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v2_resources_custom_interest_pb.CustomInterest.deserializeBinary
  );
  ...
  getCustomInterest(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v2_resources_custom_interest_pb.CustomInterest) => void) {
