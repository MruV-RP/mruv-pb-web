...
export class GenderViewServiceClient {
  ...
  methodInfoGetGenderView = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v2_resources_gender_view_pb.GenderView,
    (request: GetGenderViewRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v2_resources_gender_view_pb.GenderView.deserializeBinary
  );
  ...
  getGenderView(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v2_resources_gender_view_pb.GenderView) => void) {
