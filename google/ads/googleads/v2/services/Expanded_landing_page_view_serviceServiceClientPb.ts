...
export class ExpandedLandingPageViewServiceClient {
  ...
  methodInfoGetExpandedLandingPageView = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v2_resources_expanded_landing_page_view_pb.ExpandedLandingPageView,
    (request: GetExpandedLandingPageViewRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v2_resources_expanded_landing_page_view_pb.ExpandedLandingPageView.deserializeBinary
  );
  ...
  getExpandedLandingPageView(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v2_resources_expanded_landing_page_view_pb.ExpandedLandingPageView) => void) {
