...
export class CampaignBidModifierServiceClient {
  ...
  methodInfoGetCampaignBidModifier = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v2_resources_campaign_bid_modifier_pb.CampaignBidModifier,
    (request: GetCampaignBidModifierRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v2_resources_campaign_bid_modifier_pb.CampaignBidModifier.deserializeBinary
  );
  ...
  getCampaignBidModifier(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v2_resources_campaign_bid_modifier_pb.CampaignBidModifier) => void) {
