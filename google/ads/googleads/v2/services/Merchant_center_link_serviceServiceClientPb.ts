...
export class MerchantCenterLinkServiceClient {
  ...
  methodInfoGetMerchantCenterLink = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v2_resources_merchant_center_link_pb.MerchantCenterLink,
    (request: GetMerchantCenterLinkRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v2_resources_merchant_center_link_pb.MerchantCenterLink.deserializeBinary
  );
  ...
  getMerchantCenterLink(
    ...
    metadata: grpcWeb.Metadata | null,
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v2_resources_merchant_center_link_pb.MerchantCenterLink) => void) {
    return this.client_.rpcCall(
      this.hostname_ +
