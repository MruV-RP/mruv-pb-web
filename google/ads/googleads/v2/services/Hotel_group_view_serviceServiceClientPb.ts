...
export class HotelGroupViewServiceClient {
  ...
  methodInfoGetHotelGroupView = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v2_resources_hotel_group_view_pb.HotelGroupView,
    (request: GetHotelGroupViewRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v2_resources_hotel_group_view_pb.HotelGroupView.deserializeBinary
  );
  ...
  getHotelGroupView(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v2_resources_hotel_group_view_pb.HotelGroupView) => void) {
