...
export class MobileAppCategoryConstantServiceClient {
  ...
  methodInfoGetMobileAppCategoryConstant = new grpcWeb.AbstractClientBase.MethodInfo(
    ...
    google_ads_googleads_v2_resources_mobile_app_category_constant_pb.MobileAppCategoryConstant.deserializeBinary
  );
  ...
  getMobileAppCategoryConstant(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v2_resources_mobile_app_category_constant_pb.MobileAppCategoryConstant) => void) {
