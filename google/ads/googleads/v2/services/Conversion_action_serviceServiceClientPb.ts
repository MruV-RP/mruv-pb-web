...
export class ConversionActionServiceClient {
  ...
  methodInfoGetConversionAction = new grpcWeb.AbstractClientBase.MethodInfo(
    google_ads_googleads_v2_resources_conversion_action_pb.ConversionAction,
    (request: GetConversionActionRequest) => {
      return request.serializeBinary();
    },
    google_ads_googleads_v2_resources_conversion_action_pb.ConversionAction.deserializeBinary
  );
  ...
  getConversionAction(
    ...
    callback: (err: grpcWeb.Error,
               response: google_ads_googleads_v2_resources_conversion_action_pb.ConversionAction) => void) {
