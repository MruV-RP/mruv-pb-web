...
export class CriterionCategoryChannelAvailability extends jspb.Message {
  ...
  addAdvertisingChannelSubType(value: google_ads_googleads_v2_enums_advertising_channel_sub_type_pb.AdvertisingChannelSubTypeEnum.AdvertisingChannelSubType, index?: number): void;
