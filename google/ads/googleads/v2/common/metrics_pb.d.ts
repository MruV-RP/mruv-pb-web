...
export class Metrics extends jspb.Message {
  ...
  addInteractionEventTypes(value: google_ads_googleads_v2_enums_interaction_event_type_pb.InteractionEventTypeEnum.InteractionEventType, index?: number): void;
