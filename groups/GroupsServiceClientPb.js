...
exports.MruVGroupsServiceClient = void 0;
    ...
    MruVGroupsServiceClient.prototype.createGroup = function (request, metadata, callback) {
        if (callback !== undefined) {
            return this.client_.rpcCall(this.hostname_ +
                '/mruv.groups.MruVGroupsService/CreateGroup', request, metadata || {}, this.methodInfoCreateGroup, callback);
        }
        return this.client_.unaryCall(this.hostname_ +
            '/mruv.groups.MruVGroupsService/CreateGroup', request, metadata || {}, this.methodInfoCreateGroup);
    };
    MruVGroupsServiceClient.prototype.getGroup = function (request, metadata, callback) {
        if (callback !== undefined) {
            return this.client_.rpcCall(this.hostname_ +
                '/mruv.groups.MruVGroupsService/GetGroup', request, metadata || {}, this.methodInfoGetGroup, callback);
        }
        return this.client_.unaryCall(this.hostname_ +
            '/mruv.groups.MruVGroupsService/GetGroup', request, metadata || {}, this.methodInfoGetGroup);
    };
    MruVGroupsServiceClient.prototype.updateGroup = function (request, metadata, callback) {
        if (callback !== undefined) {
            return this.client_.rpcCall(this.hostname_ +
                '/mruv.groups.MruVGroupsService/UpdateGroup', request, metadata || {}, this.methodInfoUpdateGroup, callback);
        }
        return this.client_.unaryCall(this.hostname_ +
            '/mruv.groups.MruVGroupsService/UpdateGroup', request, metadata || {}, this.methodInfoUpdateGroup);
    };
    MruVGroupsServiceClient.prototype.deleteGroup = function (request, metadata, callback) {
        if (callback !== undefined) {
            return this.client_.rpcCall(this.hostname_ +
                '/mruv.groups.MruVGroupsService/DeleteGroup', request, metadata || {}, this.methodInfoDeleteGroup, callback);
        }
        return this.client_.unaryCall(this.hostname_ +
            '/mruv.groups.MruVGroupsService/DeleteGroup', request, metadata || {}, this.methodInfoDeleteGroup);
    };
    MruVGroupsServiceClient.prototype.getGroups = function (request, metadata, callback) {
        if (callback !== undefined) {
            return this.client_.rpcCall(this.hostname_ +
                '/mruv.groups.MruVGroupsService/GetGroups', request, metadata || {}, this.methodInfoGetGroups, callback);
        }
        return this.client_.unaryCall(this.hostname_ +
            '/mruv.groups.MruVGroupsService/GetGroups', request, metadata || {}, this.methodInfoGetGroups);
    };
    MruVGroupsServiceClient.prototype.assignOwner = function (request, metadata, callback) {
        if (callback !== undefined) {
            return this.client_.rpcCall(this.hostname_ +
                '/mruv.groups.MruVGroupsService/AssignOwner', request, metadata || {}, this.methodInfoAssignOwner, callback);
        }
        return this.client_.unaryCall(this.hostname_ +
            '/mruv.groups.MruVGroupsService/AssignOwner', request, metadata || {}, this.methodInfoAssignOwner);
    };
    MruVGroupsServiceClient.prototype.getOwner = function (request, metadata, callback) {
        if (callback !== undefined) {
            return this.client_.rpcCall(this.hostname_ +
                '/mruv.groups.MruVGroupsService/GetOwner', request, metadata || {}, this.methodInfoGetOwner, callback);
        }
        return this.client_.unaryCall(this.hostname_ +
            '/mruv.groups.MruVGroupsService/GetOwner', request, metadata || {}, this.methodInfoGetOwner);
    };
    MruVGroupsServiceClient.prototype.addMember = function (request, metadata, callback) {
        if (callback !== undefined) {
            return this.client_.rpcCall(this.hostname_ +
                '/mruv.groups.MruVGroupsService/AddMember', request, metadata || {}, this.methodInfoAddMember, callback);
        }
        return this.client_.unaryCall(this.hostname_ +
            '/mruv.groups.MruVGroupsService/AddMember', request, metadata || {}, this.methodInfoAddMember);
    };
    MruVGroupsServiceClient.prototype.getMembers = function (request, metadata, callback) {
        if (callback !== undefined) {
            return this.client_.rpcCall(this.hostname_ +
                '/mruv.groups.MruVGroupsService/GetMembers', request, metadata || {}, this.methodInfoGetMembers, callback);
        }
        return this.client_.unaryCall(this.hostname_ +
            '/mruv.groups.MruVGroupsService/GetMembers', request, metadata || {}, this.methodInfoGetMembers);
    };
    MruVGroupsServiceClient.prototype.removeMember = function (request, metadata, callback) {
        if (callback !== undefined) {
            return this.client_.rpcCall(this.hostname_ +
                '/mruv.groups.MruVGroupsService/RemoveMember', request, metadata || {}, this.methodInfoRemoveMember, callback);
        }
        return this.client_.unaryCall(this.hostname_ +
            '/mruv.groups.MruVGroupsService/RemoveMember', request, metadata || {}, this.methodInfoRemoveMember);
    };
    MruVGroupsServiceClient.prototype.addPermission = function (request, metadata, callback) {
        if (callback !== undefined) {
            return this.client_.rpcCall(this.hostname_ +
                '/mruv.groups.MruVGroupsService/AddPermission', request, metadata || {}, this.methodInfoAddPermission, callback);
        }
        return this.client_.unaryCall(this.hostname_ +
            '/mruv.groups.MruVGroupsService/AddPermission', request, metadata || {}, this.methodInfoAddPermission);
    };
    MruVGroupsServiceClient.prototype.getPermissions = function (request, metadata, callback) {
        if (callback !== undefined) {
            return this.client_.rpcCall(this.hostname_ +
                '/mruv.groups.MruVGroupsService/GetPermissions', request, metadata || {}, this.methodInfoGetPermissions, callback);
        }
        return this.client_.unaryCall(this.hostname_ +
            '/mruv.groups.MruVGroupsService/GetPermissions', request, metadata || {}, this.methodInfoGetPermissions);
    };
    MruVGroupsServiceClient.prototype.removePermission = function (request, metadata, callback) {
        if (callback !== undefined) {
            return this.client_.rpcCall(this.hostname_ +
                '/mruv.groups.MruVGroupsService/RemovePermission', request, metadata || {}, this.methodInfoRemovePermission, callback);
        }
        return this.client_.unaryCall(this.hostname_ +
            '/mruv.groups.MruVGroupsService/RemovePermission', request, metadata || {}, this.methodInfoRemovePermission);
    };
    MruVGroupsServiceClient.prototype.addSubgroup = function (request, metadata, callback) {
        if (callback !== undefined) {
            return this.client_.rpcCall(this.hostname_ +
                '/mruv.groups.MruVGroupsService/AddSubgroup', request, metadata || {}, this.methodInfoAddSubgroup, callback);
        }
        return this.client_.unaryCall(this.hostname_ +
            '/mruv.groups.MruVGroupsService/AddSubgroup', request, metadata || {}, this.methodInfoAddSubgroup);
    };
    MruVGroupsServiceClient.prototype.getSubgroups = function (request, metadata, callback) {
        if (callback !== undefined) {
            return this.client_.rpcCall(this.hostname_ +
                '/mruv.groups.MruVGroupsService/GetSubgroups', request, metadata || {}, this.methodInfoGetSubgroups, callback);
        }
        return this.client_.unaryCall(this.hostname_ +
            '/mruv.groups.MruVGroupsService/GetSubgroups', request, metadata || {}, this.methodInfoGetSubgroups);
    };
    MruVGroupsServiceClient.prototype.removeSubgroup = function (request, metadata, callback) {
        if (callback !== undefined) {
            return this.client_.rpcCall(this.hostname_ +
                '/mruv.groups.MruVGroupsService/RemoveSubgroup', request, metadata || {}, this.methodInfoRemoveSubgroup, callback);
        }
        return this.client_.unaryCall(this.hostname_ +
            '/mruv.groups.MruVGroupsService/RemoveSubgroup', request, metadata || {}, this.methodInfoRemoveSubgroup);
    };
    MruVGroupsServiceClient.prototype.isPermitted = function (request, metadata, callback) {
        if (callback !== undefined) {
            return this.client_.rpcCall(this.hostname_ +
                '/mruv.groups.MruVGroupsService/IsPermitted', request, metadata || {}, this.methodInfoIsPermitted, callback);
        }
        return this.client_.unaryCall(this.hostname_ +
            '/mruv.groups.MruVGroupsService/IsPermitted', request, metadata || {}, this.methodInfoIsPermitted);
    };
    MruVGroupsServiceClient.prototype.getServiceStatus = function (request, metadata, callback) {
        if (callback !== undefined) {
            return this.client_.rpcCall(this.hostname_ +
                '/mruv.groups.MruVGroupsService/GetServiceStatus', request, metadata || {}, this.methodInfoGetServiceStatus, callback);
        }
        return this.client_.unaryCall(this.hostname_ +
            '/mruv.groups.MruVGroupsService/GetServiceStatus', request, metadata || {}, this.methodInfoGetServiceStatus);
    };
    MruVGroupsServiceClient.prototype.getServiceVersion = function (request, metadata, callback) {
        if (callback !== undefined) {
            return this.client_.rpcCall(this.hostname_ +
                '/mruv.groups.MruVGroupsService/GetServiceVersion', request, metadata || {}, this.methodInfoGetServiceVersion, callback);
        }
        return this.client_.unaryCall(this.hostname_ +
            '/mruv.groups.MruVGroupsService/GetServiceVersion', request, metadata || {}, this.methodInfoGetServiceVersion);
    };
