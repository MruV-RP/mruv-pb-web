...
var MruVCharactersServiceClient = /** @class */ (function () {
    ...
    MruVCharactersServiceClient.prototype.createCharacter = function (request, metadata, callback) {
        ...
        return this.client_.unaryCall(this.hostname_ +
            '/mruv.MruVCharactersService/CreateCharacter', request, metadata || {}, this.methodInfoCreateCharacter);
    };
    MruVCharactersServiceClient.prototype.getCharacter = function (request, metadata, callback) {
        ...
        return this.client_.unaryCall(this.hostname_ +
            '/mruv.MruVCharactersService/GetCharacter', request, metadata || {}, this.methodInfoGetCharacter);
    };
    MruVCharactersServiceClient.prototype.updateCharacter = function (request, metadata, callback) {
        if (callback !== undefined) {
            return this.client_.rpcCall(this.hostname_ +
                '/mruv.MruVCharactersService/UpdateCharacter', request, metadata || {}, this.methodInfoUpdateCharacter, callback);
        }
        return this.client_.unaryCall(this.hostname_ +
            '/mruv.MruVCharactersService/UpdateCharacter', request, metadata || {}, this.methodInfoUpdateCharacter);
    };
    MruVCharactersServiceClient.prototype.deleteCharacter = function (request, metadata, callback) {
        if (callback !== undefined) {
            return this.client_.rpcCall(this.hostname_ +
                '/mruv.MruVCharactersService/DeleteCharacter', request, metadata || {}, this.methodInfoDeleteCharacter, callback);
        }
        return this.client_.unaryCall(this.hostname_ +
            '/mruv.MruVCharactersService/DeleteCharacter', request, metadata || {}, this.methodInfoDeleteCharacter);
    };
    MruVCharactersServiceClient.prototype.permanentCharacterKill = function (request, metadata, callback) {
        ...
        return this.client_.unaryCall(this.hostname_ +
            '/mruv.MruVCharactersService/PermanentCharacterKill', request, metadata || {}, this.methodInfoPermanentCharacterKill);
    };
    MruVCharactersServiceClient.prototype.changeClothes = function (request, metadata, callback) {
        if (callback !== undefined) {
            return this.client_.rpcCall(this.hostname_ +
                '/mruv.MruVCharactersService/ChangeClothes', request, metadata || {}, this.methodInfoChangeClothes, callback);
        }
        return this.client_.unaryCall(this.hostname_ +
            '/mruv.MruVCharactersService/ChangeClothes', request, metadata || {}, this.methodInfoChangeClothes);
    };
    ...
    MruVCharactersServiceClient.prototype.getServiceStatus = function (request, metadata, callback) {
        ...
        return this.client_.unaryCall(this.hostname_ +
            '/mruv.MruVCharactersService/GetServiceStatus', request, metadata || {}, this.methodInfoGetServiceStatus);
    };
    MruVCharactersServiceClient.prototype.getServiceVersion = function (request, metadata, callback) {
        ...
        return this.client_.unaryCall(this.hostname_ +
            '/mruv.MruVCharactersService/GetServiceVersion', request, metadata || {}, this.methodInfoGetServiceVersion);
    };
